/**CFile****************************************************************
  ...
  Revision    [$Id: fpgaInt.h,v 1.7 2005/07/08 01:01:23 alanmi Exp $]
...
struct Fpga_CutStruct_t_  
{
    ...
    unsigned            uTruthTemp[4]; // the temporary truth table used to derive other cuts
    unsigned            uTruthZero[4]; // the temporary truth table used to derive other cuts
    ...
    Fpga_Cut_t *        pNextT;        // the pointer to the next cut in the list
};
