/**CFile****************************************************************
  ...
  Revision    [$Id: mvcApi.c,v 1.9 2003/09/01 04:56:49 alanmi Exp $]
...
***********************************************************************/
bool Mvc_CoverIsEmpty( Mvc_Cover_t * pCover )
{
    return (bool)(Mvc_CoverReadCubeNum(pCover) == 0);
}
...
***********************************************************************/
bool Mvc_CoverIsTautology( Mvc_Cover_t * pCover )
{
    Mvc_Cube_t * pCube;
    int iBit, Value;
...
***********************************************************************/
bool Mvc_CoverIsBinaryBuffer( Mvc_Cover_t * pCover )
{
    Mvc_Cube_t * pCube;
    if ( pCover->nBits != 2 )
        return 0;
