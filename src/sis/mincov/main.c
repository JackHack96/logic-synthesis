 ...
 *
 * $Source: /projects/mvsis/Repository/mvsis-1.3/src/sis/mincov/main.c,v $
 * $Author: wjiang $
 * $Revision: 1.1.1.1 $
...
char **argv;
{
    ...
    switch (opt) {
    case 0:
	if (A->nrows < 25) sm_print(fp, A);
	cover = sm_minimum_cover(A, NIL(int), heuristic, verbose);
