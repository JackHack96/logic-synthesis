/**CFile****************************************************************
  ...
  Revision    [$Id: extraZddIsop.c,v 1.1 2003/12/02 23:20:49 alanmi Exp $]
  ...
  DdNode * bFuncOnDc)  /* the on-set + dc-set */
{
    DdHashTable * table;
    DdNode      * res;
    int         * pPerm = extraGenerateRandomPermutation( dd->sizeZ/2 );
...
int * extraGenerateRandomPermutation( int nVars )
{
