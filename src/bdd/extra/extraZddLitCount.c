/**CFile****************************************************************
  ...
  Revision    [$Id: extraZddLitCount.c,v 1.1 2003/12/02 23:20:50 alanmi Exp $]
...
/*---------------------------------------------------------------------------*/
static nodeinfo* extraZddLitCount ARGS((DdManager * dd, DdNode * Set));
            
/* local memory manager */
static int       localMemManagerStart ARGS(());
static nodeinfo* localMemManagerLinkNext ARGS(());
static void      localMemManagerDissolve ARGS(());
