/**CFile****************************************************************
  ...
  FileName    [extraZddSubSup.c]

  PackageName [extra]

  Synopsis    [SubSet, SupSet, NotSubSet, NotSupSet used to solve problems 
  arising in two-level SOP minimization. See O. Coudert, "Two-Level Logic 
  Minimization:An Overview", Integration. Vol. 17, No. 2, pp. 97-140, Oct 1994.]
  ...
  Revision    [$Id: extraZddSubSup.c,v 1.4 2003/11/18 18:55:01 alanmi Exp $]
