/**CFile****************************************************************
  ...
  Synopsis    [Procedures for the computation of autosymmetry
  based on the following publications: (1) V. Ciriani, "Logic 
  Minimization Using Exclusive OR Gates", DAC 2001.
  (2) A. Bernasconi, V. Ciriani, F. Lucio, L. Pagli, "Fast Three-Level 
  Logic Minimization Based on Autosymmetry", Proc. DAC 2002.]
  ...
  Revision    [$Id: extraBddAuto.c,v 1.1 2003/11/18 18:54:57 alanmi Exp $]
...
***********************************************************************/
DdNode * Extra_zddSpaceFromMatrixPos( DdManager * dd, DdNode * zA )
{
    DdNode * zRes;
    do {
        dd->reordered = 0;
        zRes = Extra_zddSpaceFromMatrixPosInternal( dd, zA, -1 );
    } while (dd->reordered == 1);
    return zRes;
}
...
***********************************************************************/
DdNode * Extra_zddSpaceFromMatrixNeg( DdManager * dd, DdNode * zA )
{
    DdNode * zRes;
    do {
        dd->reordered = 0;
        zRes = Extra_zddSpaceFromMatrixNegInternal( dd, zA, -1 );
    } while (dd->reordered == 1);
    return zRes;
}
...
***********************************************************************/
DdNode * Extra_zddSpaceFromMatrixPosInternal( DdManager * dd, DdNode * zA, int levelPrev )
{
    DdNode * zRes;
    DdNode * zTemp;
    int Level;

    zRes = extraZddSpaceFromMatrixPos( dd, zA );
    if ( zRes == NULL )
        return NULL;
    ...
    cuddRef( zRes );
    for ( Level = ((cuddIsConstant(zA))? dd->sizeZ: dd->permZ[zA->index]) - 1; Level > levelPrev; Level-- )
    {
        zRes = cuddZddGetNode( dd, dd->invpermZ[Level], zTemp = zRes, zRes );
        if ( zRes == NULL ) 
        {
            Cudd_RecursiveDerefZdd(dd, zTemp);
            return NULL;
...
***********************************************************************/
DdNode * Extra_zddSpaceFromMatrixNegInternal( DdManager * dd, DdNode * zA, int levelPrev )
{
    DdNode * zRes;
    DdNode * zTemp;
    int Level;

    zRes = extraZddSpaceFromMatrixNeg( dd, zA );
    if ( zRes == NULL )
        return NULL;
    ...
    cuddRef( zRes );
    for ( Level = ((cuddIsConstant(zA))? dd->sizeZ: dd->permZ[zRes->index]) - 1; Level > levelPrev; Level-- )
    {
        zRes = cuddZddGetNode( dd, dd->invpermZ[Level], zTemp = zRes, zRes );
        if ( zRes == NULL ) 
        {
...
/**Function*************************************************************
  ...
  Synopsis    [Performs the recursive step of Extra_zddSpaceFromMatrixPos().]
...
***********************************************************************/
DdNode * extraZddSpaceFromMatrixPos( DdManager * dd, DdNode * zA )
{
    DdNode * zRes;
    statLine( dd );
    ...
    if ( zRes = cuddCacheLookup1Zdd(dd, extraZddSpaceFromMatrixPos, zA) )
        return zRes;
    else
    {
        DdNode * zT0, * zT1, * zT2;
        ...
        zT0 = Extra_zddSpaceFromMatrixPosInternal( dd, cuddE(zA), dd->permZ[zA->index] );
        if ( zT0 == NULL )
            return NULL;
        cuddRef( zT0 );
        
        zT1 = Extra_zddSpaceFromMatrixPosInternal( dd, cuddT(zA), dd->permZ[zA->index] );
        if ( zT1 == NULL )
        {
            Cudd_RecursiveDerefZdd( dd, zT0 );
            return NULL;
        }
        cuddRef( zT1 );

        zT2 = Extra_zddSpaceFromMatrixNegInternal( dd, cuddT(zA), dd->permZ[zA->index] );
        if ( zT2 == NULL )
        {
            Cudd_RecursiveDerefZdd( dd, zT0 );
            Cudd_RecursiveDerefZdd( dd, zT1 );
            return NULL;
        }
        cuddRef( zT2 );


        zRes0  = cuddZddIntersect( dd, zT0, zT1 );
        if ( zRes0 == NULL )
        {
            Cudd_RecursiveDerefZdd( dd, zT0 );
            Cudd_RecursiveDerefZdd( dd, zT1 );
            Cudd_RecursiveDerefZdd( dd, zT2 );
            return NULL;
        }
        cuddRef( zRes0 );
        Cudd_RecursiveDerefZdd( dd, zT1 );

        zRes1  = cuddZddIntersect( dd, zT0, zT2 );
        if ( zRes1 == NULL )
        {
            Cudd_RecursiveDerefZdd( dd, zT0 );
            Cudd_RecursiveDerefZdd( dd, zT2 );
        ...
        zRes = cuddZddGetNode( dd, zA->index, zRes1, zRes0 );
        if ( zRes == NULL ) 
        {
            Cudd_RecursiveDerefZdd(dd, zRes0);
            Cudd_RecursiveDerefZdd(dd, zRes1);
        ...
        cuddCacheInsert1( dd, extraZddSpaceFromMatrixPos, zA, zRes );
        return zRes;
    }
}
...
/**Function*************************************************************
  ...
  Synopsis    [Performs the recursive step of Extra_zddSpaceFromMatrixNeg().]
...
***********************************************************************/
DdNode * extraZddSpaceFromMatrixNeg( DdManager * dd, DdNode * zA )
{
    DdNode * zRes;
    statLine( dd );
    ...
    if ( zRes = cuddCacheLookup1Zdd(dd, extraZddSpaceFromMatrixNeg, zA) )
        return zRes;
    else
    {
        DdNode * zT0, * zT1, * zT2;
        ...
        zT0 = Extra_zddSpaceFromMatrixNegInternal( dd, cuddE(zA), dd->permZ[zA->index] );
        if ( zT0 == NULL )
            return NULL;
        cuddRef( zT0 );
        
        zT1 = Extra_zddSpaceFromMatrixNegInternal( dd, cuddT(zA), dd->permZ[zA->index] );
        if ( zT1 == NULL )
        {
            Cudd_RecursiveDerefZdd( dd, zT0 );
            return NULL;
        ...
        zT2 = Extra_zddSpaceFromMatrixPosInternal( dd, cuddT(zA), dd->permZ[zA->index] );
        if ( zT2 == NULL )
        {
            Cudd_RecursiveDerefZdd( dd, zT0 );
            Cudd_RecursiveDerefZdd( dd, zT1 );
        ...
        cuddCacheInsert1( dd, extraZddSpaceFromMatrixNeg, zA, zRes );
        return zRes;
    }
}
