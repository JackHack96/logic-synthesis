/**CFile****************************************************************
  ...
  Revision    [$Id: msatInt.h,v 1.1 2005/07/08 01:01:36 alanmi Exp $]
...
extern Msat_MmFixed_t *    Msat_MmFixedStart( int nEntrySize, int nChunkSize, int nChunksAlloc );
...
extern Msat_MmFlex_t *     Msat_MmFlexStart( int nChunkSize, int nChunksAlloc );
