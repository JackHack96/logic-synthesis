...
int normal_input_proximity(x, y) int x, y;
{
  int i;
  int prox;
  int pprox;
...
int normal_output_proximity(x, y) int x, y;
{
  int i;
  int prox;
  int pprox;
