 ...
 */
    if (bdd_constcache_lookup(manager, f, g, h, &ret_status)) {
        ...
        if (complement) {
            switch (ret_status) {
                case bdd_constant_zero: ret_status = bdd_constant_one;
                    break;
                case bdd_constant_one: ret_status = bdd_constant_zero;
                    break;
        ...
        boolean complement;
{
    if (complement) {
        switch (status) {
            case bdd_constant_zero: status = bdd_constant_one;
                break;
            case bdd_constant_one: status = bdd_constant_zero;
                break;
            case bdd_nonconstant:
                /* leave it alone */
                break;
