...
void simulate_node(node) node_t *node;
{
  int i, value;
...
array_t *simulate_network(network, node_vec, in_value) network_t *network;
...
array_t *simulate_stg(stg, in_value, state) graph_t *stg;
array_t *in_value;
vertex_t **state;
{
...
int sim_verify(network0, network1, n_patterns) network_t *network0;
network_t *network1;
int n_patterns;
{
  int i, j, k;
...
static void report_error(pi_values, po_values, networks,
                         faulty_po) int *pi_values;
int **po_values;
network_t **networks;
int faulty_po;
{
...
static void print_pattern(n, pattern, mask) int n;
int *pattern;
int mask;
{
  int i;
...
static void gen_random_pattern(n, pattern, seed) int n;
int *pattern;
int seed;
{
  int i;
...
static void simulate_network_32(network, pi_values,
...
static int simulate_network_32_rec(network, table, node) network_t *network;
st_table *table;
node_t *node;
{
  int i;
...
static int simulate_node_32(node, inputs) node_t *node;
int **inputs;
{
  register int i, j;
  node_t *fanin;
