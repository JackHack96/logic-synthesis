...
static void dump_outputs(fp, n, vec) FILE *fp;
network_t *n;
array_t *vec;
{
  int i;
...
static int com_simulate(network, argc, argv) network_t **network;
int argc;
char **argv;
{
  int i, j;
...
static int com_set_state(network, argc, argv) network_t **network;
int argc;
char **argv;
{
  int do_stg = 1;
...
/*ARGSUSED*/
static int com_print_state(network, argc, argv) network_t **network;
int argc;
char **argv;
{
  lsGen gen;
...
static int dump_vector(fp, vec) FILE *fp;
array_t *vec;
{
  int i;
...
static int com_sim_verify(network, argc, argv) network_t **network;
int argc;
char **argv;
{
  int c;
