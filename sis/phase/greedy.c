...
void phase_random_greedy(network_t *network, int num) {
...
void phase_quick(network_t *network) {
...
void phase_good(network_t *network) {
    net_phase_t *net_phase;
    bool        not_done;
...
static void greedy_down(net_phase_t *net_phase) {
 ...
 *  return FALSE.
 */
static bool KL_up(net_phase_t *net_phase) {
