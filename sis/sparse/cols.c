 ...
 *  compile flag ...
 */
void sm_col_free(pcol) register sm_col *pcol;
{
 ...
 */
sm_col *sm_col_dup(pcol) register sm_col *pcol;
{
 ...
 */
sm_element *sm_col_insert(pcol, row) register sm_col *pcol;
register int row;
{
 ...
 */
void sm_col_remove(pcol, row) register sm_col *pcol;
register int row;
{
  register sm_element *p;
 ...
 */
sm_element *sm_col_find(pcol, row) sm_col *pcol;
int row;
{
  register sm_element *p;
 ...
 */
int sm_col_contains(p1, p2) sm_col *p1, *p2;
{
 ...
 */
int sm_col_intersects(p1, p2) sm_col *p1, *p2;
{
  register sm_element *q1, *q2;
 ...
 */
int sm_col_compare(p1, p2) sm_col *p1, *p2;
{
  register sm_element *q1, *q2;
 ...
 */
sm_col *sm_col_and(p1, p2) sm_col *p1, *p2;
{
  register sm_element *q1, *q2;
 ...
 */
void sm_col_remove_element(pcol, p) register sm_col *pcol;
register sm_element *p;
{
  dll_unlink(p, pcol->first_row, pcol->last_row, next_row, prev_row,
             pcol->length);
...
void sm_col_print(fp, pcol) FILE *fp;
sm_col *pcol;
{
  sm_element *p;
