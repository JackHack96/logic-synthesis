...
int network_cleanup(network_t *network) {
...
int network_ccleanup(network_t *network) { return network_cleanup_util(network, 0, NIL(int)); }

int network_cleanup_util(network_t *network, int sweep_latch, int *latch_removed) {
    node_t *p;
