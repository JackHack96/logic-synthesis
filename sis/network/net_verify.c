...
int net_verify_with_dc(network1, network2, method, verbose) network_t *network1;
network_t *network2;
int method;
int verbose;
{
...
int network_verify(network1_t, network2_t, method) network_t *network1_t;
...
int verify_by_collapse(network1, network2) network_t *network1;
network_t *network2;
{
