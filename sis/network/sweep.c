...
#ifdef SIS
int network_sweep_latch(latch, reached_table) latch_t *latch;
...
int network_sweep_node(node) node_t *node;
{
...
int network_sweep(network) network_t *network;
{
...
int network_csweep(network) network_t *network;
{ return network_sweep_util(network, 0, NIL(int)); }

int network_sweep_util(network, sweep_latch, latch_removed) network_t *network;
int sweep_latch;
int *latch_removed;
{
