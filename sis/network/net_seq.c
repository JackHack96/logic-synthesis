...
node_t *network_latch_end(node_t *node) {
    node_type_t type;
    network_t   *network;
    latch_t     *latch;
 ...
 */
void network_create_latch(network_t *network, latch_t **l, node_t *n1, node_t *n2) {
    lsGen    gen;
    node_t   *fo;
...
void network_delete_latch(network_t *network, latch_t *l) {
    lsGen gen;
    char  *data = NIL(char);
...
void network_delete_latch_gen(network_t *network, lsGen gen) {
    node_t  *input, *output;
    latch_t *latch;
...
void network_disconnect(node_t *node1, node_t *node2, node_t **po_ptr, node_t **pi_ptr) {
...
void network_connect(node_t *node1, node_t *node2) {
    lsGen     gen;
...
graph_t *network_stg(network_t *network) {
    if (network == NIL(network_t)) {
...
void network_set_stg(network_t *network, graph_t *stg) {
    if (network == NIL(network_t)) {
...
int network_stg_check(network_t *network) {
    array_t      *po_list, *ar;
 ...
 */
static int network_is_real_pio(network_t *network, node_t *node, latch_t **latchp) {
    st_table  *latch_table;
    network_t *net;
...
int network_is_real_po(network_t *network, node_t *node) {
    latch_t *latch;
...
int network_is_real_pi(network_t *network, node_t *node) {
    latch_t *latch;
...
int network_is_control(network_t *network, node_t *node) {
    latch_t *latch;
...
node_t *network_get_control(network_t *network, node_t *control) {
    lsGen  gen;
    node_t *fo;
 ...
 * correctly.
 */
node_t *network_add_fake_primary_output(network_t *network, node_t *node) {
    node_t *out;
 ...
 * other name.
 */
void network_replace_io_fake_names(network_t *network) {
    lsGen    gen;
    st_table *name_table;
...
static void snetwork_dfs_recur(node_t *node, st_table *visited) {
    char   *dummy;
    int    i;
    node_t *fanin;
...
st_table *snetwork_tfi_po(network_t *network) {
    st_table     *visited;
    lsGen        gen;
    node_t       *po;
    st_generator *sgen;
