...
int network_append(network1, network2_copy) network_t *network1;
network_t *network2_copy;
{
  network_t *network2;
...
static node_t *copy_node(network1, node2, name_hack) network_t *network1;
node_t *node2;
int name_hack;
{
  node_t *new_node;
...
static char *gen_unique_name(network, node) network_t *network;
node_t *node;
{
  char new_name[1024];
  int count;
...
static int add_node_by_name(network1, node2) network_t *network1;
node_t *node2;
{
  node_t *temp, *node1;
  char errmsg[1024];
