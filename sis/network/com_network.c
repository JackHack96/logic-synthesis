...
static int com_ripup(network, argc, argv) network_t **network;
int argc;
char **argv;
{
  array_t *node_vec;
...
static int com_collapse(network, argc, argv) network_t **network;
int argc;
char **argv;
{
  array_t *node_vec;
...
/* ARGSUSED */
static int com_sweep(network, argc, argv) network_t **network;
int argc;
char **argv;
{
  if (argc != 1) {
...
/* ARGSUSED */
static int com_espresso(network, argc, argv) network_t **network;
int argc;
char **argv;
{
  network_t *new_net;
...
static int com_check(network, argc, argv) network_t **network;
int argc;
char **argv;
{
...
/* ARGSUSED */
static int com_verify(network, argc, argv) network_t **network;
int argc;
char **argv;
{
