...
array_t *network_dfs(network) network_t *network;
{
  int i;
  st_table *visited;
  array_t *roots;
...
array_t *network_special_dfs(network) network_t *network;
{
  int i;
  st_table *visited;
  array_t *roots;
...
array_t *network_dfs_from_input(network) network_t *network;
{
  int i;
  st_table *visited;
  array_t *node_vec;
...
array_t *network_tfi(node, level) node_t *node;
int level;
{
  st_table *visited;
  array_t *node_vec;
...
array_t *network_tfo(node, level) node_t *node;
int level;
{
  st_table *visited;
  array_t *node_vec;
...
static int network_dfs_recur(node, node_vec, visited, dir, level) node_t *node;
array_t *node_vec;
st_table *visited;
