...
void simplify_node(f, method, dctype, accept, filter, level_table) node_t *f;
sim_method_t method;
sim_dctype_t dctype;
sim_accept_t accept;
sim_filter_t filter;
...
static void simp_accept(f, newf, accept) node_t *f, *newf;
sim_accept_t accept;
{
  bool do_accept;
  int old, new;
...
void simplify_cspf_node(f, method, dctype, accept, filter, level_table, mg,
                        leaves) node_t *f;
sim_method_t method;
sim_dctype_t dctype;
sim_accept_t accept;
...
static node_t *local_dc(f, mg, leaves, filter, level_table) node_t *f;
bdd_manager *mg;
st_table *leaves;
sim_filter_t filter;
st_table *level_table;
