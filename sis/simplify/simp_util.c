...
void copy_dcnetwork(network_t *network) {
...
node_t *find_node_exdc(node_t *ponode, st_table *node_exdc_table) {
    node_t *dcponode;
    char   *dummy;
...
void free_dcnetwork_copy(network_t *network) {
    node_t    *dcnode;
    int       i;
    network_t *DC_network;
    array_t   *dc_list;
...
array_t *order_nodes_elim(network_t *network) {
...
static int level_elim_cmp(char **obj1, char **obj2) {
    node_t *node1, *node2;
...
int num_cube_cmp(char **obj1, char **obj2) {
    node_t *node1, *node2;
...
array_t *simp_order(array_t *nodevec) {
    node_t       *cn;
...
int fsize_cmp(char **obj1, char **obj2) {
