...
void copy_dcnetwork(network) network_t *network;
{
...
void free_dcnetwork_copy(network) network_t *network;
{
  node_t *dcnode;
  int i;
  network_t *DC_network;
...
array_t *order_nodes_elim(network) network_t *network;
{
...
static int level_elim_cmp(obj1, obj2) char **obj1;
char **obj2;
{
  node_t *node1, *node2;
...
int num_cube_cmp(obj1, obj2) char **obj1;
char **obj2;
{
  node_t *node1, *node2;
...
array_t *simp_order(nodevec) array_t *nodevec;
{
  node_t *cn;
...
int fsize_cmp(obj1, obj2) char **obj1;
char **obj2;
{
