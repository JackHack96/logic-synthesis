 ...
 */
void fdc_sm_bp_1(sm_matrix *M, sm_col *ex_col) {
    sm_row *prow;
    sm_col *pcol;
    int    i, init_rows;
...
static void bd_comp_exact(sm_matrix *M, sm_col *ex_col) {
 ...
 * in simplification.
 */
void fdc_sm_bp_6(sm_matrix *M, int distance) {
    sm_row     *prow;
    sm_element *p;
    sm_col     *pcol;
 ...
 * in simplification.
 */
void fdc_sm_bp_7(sm_matrix *M, int distance) {
    sm_row     *prow, *pr;
    sm_element *p;
    sm_col     *pcol;
    int        i, init_rows;
...
array_t *sm_col_count_init(int size) {
...
sm_col *sm_get_long_col(sm_matrix *M, array_t *chosen) {
 ...
 * "p" is an on set cube
 * "r" is a dc set cube */
bool dist_check(sm_matrix *M, sm_row *p, sm_row *r, int distance) {
