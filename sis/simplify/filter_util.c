 ...
 */
void fdc_sm_bp_1(M, ex_col) sm_matrix *M;
sm_col *ex_col;
{
  sm_row *prow;
  sm_col *pcol;
...
static void bd_comp_exact(M, ex_col) sm_matrix *M;
sm_col *ex_col;
{
 ...
 */
void fdc_sm_bp_2(M) sm_matrix *M;
{
  sm_row *prow;
  sm_col *pcol;
  sm_element *p;
 ...
 * dont cares that are useful in simplification.
 */
void fdc_sm_bp_4(M) sm_matrix *M;
{
  sm_row *prow;
  sm_col *pcol;
  sm_element *p;
 ...
 * in simplification.
 */
void fdc_sm_bp_6(M, distance) sm_matrix *M;
int distance;
{
  sm_row *prow;
  sm_element *p;
 ...
 * in simplification.
 */
void fdc_sm_bp_7(M, distance) sm_matrix *M;
int distance;
{
  sm_row *prow, *pr;
  sm_element *p;
...
array_t *sm_col_count_init(size) int size;
{
...
sm_col *sm_get_long_col(M, chosen) sm_matrix *M;
array_t *chosen;
{
 ...
 * "p" is an on set cube
 * "r" is a dc set cube */
bool dist_check(M, p, r, distance) sm_matrix *M;
sm_row *p, *r;
int distance;
{
