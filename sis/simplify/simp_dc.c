...
node_t *unused_simp_fanin_dc(f) node_t *f;
{
  st_table *table;
...
static st_table *simp_table(f) node_t *f;
{
...
static array_t *simp_nodefanout_vec(f) node_t *f;
{
...
static void nodefanout_print(vec) array_t *vec;
{
  int i;
  nodefanout_t nf;
...
static void fanout_table_print(table) st_table *table;
{
  char *dummy;
  st_generator *gen;
  node_t *x;
...
node_t *simp_fanout_dc(f) node_t *f;
{
  lsGen gen;
...
node_t *simp_inout_dc(f, il, iol) node_t *f;
int il, iol;
{
...
node_t *simp_tfanin_dc(f, il, ol) node_t *f;
int il, ol;
{
...
node_t *simp_sub_fanin_dc(f) node_t *f;
{
...
static array_t *get_sub_list(f) node_t *f;
{
...
node_t *simp_level_dc(f, level_table) node_t *f;
