...
static void simp_free_bddlist(array_t *bdd_list, array_t *node_list) {
    int   j;
    bdd_t *bdd;
 ...
 */
node_t *simp_bull_cofactor(array_t *bdd_list, array_t *node_list, bdd_manager *mg, st_table *leaves) {
    int       i;
    bdd_t     *bdd;
    bdd_t     *c, *cbar;
...
static array_t *simp_disjoint_support_functions(array_t *list) {
    int       row, column;
    int       i, j;
    int       flag;
    array_t   *tmp;
...
static node_t *simp_range_2_compute(var_set_t *set, array_t *bdd_list, array_t *node_list) {
    int    i, j;
    int    k1, k2;
...
int set_size_sort(char **obj1, char **obj2) {
    node_t *node1, *node2;
    int    el1, el2;
