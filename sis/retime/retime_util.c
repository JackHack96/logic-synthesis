...
void re_graph_free(re_graph *graph) {
    int     i;
    re_node *node;
    re_edge *edge;
...
re_graph *re_graph_dup(re_graph *graph) {
    int      i, j;
    re_graph *new_graph;
...
re_node *re_get_node(re_graph *graph, int index) {
...
re_edge *re_get_edge(re_graph *graph, int index) {
...
re_node *re_get_primary_input(re_graph *graph, int index) {
...
re_node *re_get_primary_output(re_graph *graph, int index) {
...
re_edge *re_get_fanin(re_node *node, int index) {
...
re_edge *re_get_fanout(re_node *node, int index) {
...
re_edge *re_create_edge(re_graph *graph, re_node *source, re_node *sink, int index, int weight, double breadth) {
    re_edge *new_edge;
...
re_edge *re_edge_dup(re_edge *edge) {
    int     i;
    re_edge *new_edge;
...
re_node *re_node_dup(re_node *node) {
    re_node *new_node;
