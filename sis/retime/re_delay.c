 ...
 */
double re_cycle_delay(re_graph *graph, double delay_r) {
    re_node *node;
    bool    *valid_table;
 ...
 */
void re_evaluate_delay(re_node *node, bool *valid_table, double *delay_table) {
    int     i;
    double  m;
    re_edge *edge;
 ...
 */
double retime_cycle_lower_bound(re_graph *graph) {
    int     i;
    re_node *node;
    double  bound;
