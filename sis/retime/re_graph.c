...
int retime_graph_interface(graph, area_r, delay_r, retime_tol, d_clk,
                           new_c) re_graph *graph;
 ...
 */
int retime_graph(network, graph, area_r, delay_r, retime_tol, d_clk, new_c,
                 lp_flag, min_reg, should_init,
                 can_initialize) network_t *network;
re_graph *graph;
