...
void re_computeWD(re_graph *graph, int N, st_table *table, wd_t ***pWD) {
    double  t;
    wd_t    **WD;
    re_edge *edge;
    re_node *sink;
...
static int greater(wd_t WD1, wd_t WD2, wd_t WD3) {
...
static void sum(wd_t *pWD1, wd_t WD2, wd_t WD3) {
    pWD1->w = WD2.w + WD3.w;
    pWD1->d = WD2.d + WD3.d;
}
