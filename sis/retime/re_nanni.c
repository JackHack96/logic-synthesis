...
static void retime_allocate_delay_data(n) int n;
{
...
int retime_nanni_routine(graph, d_clk, retiming) re_graph *graph;
double d_clk;
...
static int retime_set_outputs(graph, M, retiming) re_graph *graph;
array_t *M;
int *retiming;
{
  int i;
 ...
 */
static st_table *retime_get_po_from_array(M) array_t *M;
{
  int i;
  re_node *node;
  st_table *table;
 ...
 */
static array_t *retime_get_slow_nodes(graph, clk) re_graph *graph;
double clk;
{
...
static array_t *retime_get_input_reachable(graph) re_graph *graph;
{
  array_t *S;
  re_edge *edge;
  re_node *node;
...
static int re_translate_retiming_vector(graph, r) re_graph *graph;
int *r;
{
  re_node *re_no;
