...
/* ARGSUSED */
int retime_lies_routine(re_graph *graph, double c, int *retiming) {
...
static void re_free_lies_graph(struct a_graph *milp_graph) {
    int           i;
    struct a_node **nodes;
 ...
 */
static void re_add_edge_constraint(struct a_graph *graph, int from, int to, re_edge *edge, double c) {
    int           count;
    double        node_delay;
...
static void re_add_vertex_constraints(struct a_graph *graph, re_node *re_no, int to, double c) {
    int           count, num_int;
    double        node_delay;
    struct a_edge **edge_array;
...
static void re_add_usertime_constraints(struct a_graph *graph, st_table *table, re_node *re_no, double c) {
    re_edge       *re_ed;
...
void re_add_edges_to_graph(struct a_graph *graph, int num) {
...
static void re_node_to_index(st_table *table, re_node *node, int *index) {
