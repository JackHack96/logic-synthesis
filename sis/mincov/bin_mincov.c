...
sm_row *sm_mat_bin_minimum_cover(M, weights, heuristic, debug, ubound, option,
                                 record_fun)
...
sm_row *sm_mat_minimum_cover(M, weights, heuristic, debug, ubound, option,
                             record_fun)
...
static sm_row *mat_minimum_cover(M, w, heuristic, l_debug, ubound, l_option,
                                 record_fun)
...
static sm_matrix *reorder_rows(M)
 ...
 */
static int compare(value1, value2)
...
static int compare_rev(value1, value2)
...
/* debugging stuff */
static char *literal_name(literal)
...
pm(mat) sm_matrix *mat;
{ sm_print(misout, mat); }

wm(mat) sm_matrix *mat;
{ sm_write(misout, mat); }
