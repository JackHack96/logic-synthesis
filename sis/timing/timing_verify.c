...
int tmg_check_clocking_scheme(latch_graph, network) graph_t *latch_graph;
network_t *network;
{
...
trace_erroneous_path(latch_graph, clock_event, cycle, u) graph_t *latch_graph;
clock_event_t *clock_event;
double cycle;
vertex_t *u;
{
...
int trace_recursive_path(latch_graph, clock_event, cycle, u, A,
                         path) graph_t *latch_graph;
clock_event_t *clock_event;
double cycle;
vertex_t *u;
double A, *path;
...
clock_event_t *tmg_get_clock_events(latch_graph, network) graph_t *latch_graph;
network_t *network;
{
  clock_event_t *clock_event;
...
tmg_free_clock_event(clock_event) clock_event_t *clock_event;
{
