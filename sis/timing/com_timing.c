...
*/
int com_clock_optimize(network_t **network, int argc, char **argv) {
    int           c;
    graph_t       *latch_graph;
    delay_model_t model;
        ...
        switch (c) {
            case 'd':
                switch (atoi(util_optarg)) {
                    case 0:debug_type = ALL;
                        break;
                    case 1:debug_type = LGRAPH;
                        break;
                    case 2:debug_type = CGRAPH;
                        break;
                    case 3:debug_type = BB;
                        break;
                    case 4:debug_type = GENERAL;
                        break;
                    default:debug_type = NONE;
                        break;
                }
                break;
            case 'n':model = DELAY_MODEL_UNIT_FANOUT;
                break;
...
*/
int com_clock_check(network_t **network, int argc, char **argv) {
    int           c, flag;
    graph_t       *latch_graph;
    delay_model_t model;
    double        set_up, hold;
