...
int
timing_network_check(network, model)
network_t *network;
delay_model_t model;
{
...
*/ 
static int 
tmg_clock_compare (char **k1, char **k2)
{
...
int 
tmg_set_set_up (double s)
{
    Uset_up = s;
}

int 
tmg_set_hold (double s)
{
    Uhold = s;
}
...
int 
tmg_set_min_sep (double s)
{
    Umin_sep = s;
}

int 
tmg_set_max_sep (double s)
{
    Umax_sep = s;
}

double 
tmg_get_min_sep (void)
{
    return Umin_sep;
}

double 
tmg_get_max_sep (void)
{
    return Umax_sep;
}
...
int 
tmg_set_gen_algorithm_flag (int value)
{
    algorithm_flag = value;
}

int 
tmg_get_gen_algorithm_flag (void)
{
    return algorithm_flag;
}

int 
tmg_set_phase_inv (int flag)
{
    phase_inv = flag;
}

int 
tmg_get_phase_inv (void)
{
    return phase_inv;
}
