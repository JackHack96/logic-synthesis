...
double tmg_compute_optimal_clock(graph_t *latch_graph, network_t *network) {
    graph_t *clock_graph;
    phase_t *phase;
...
*/
double tmg_clock_lower_bound(graph_t *g) {
...
*/
double tmg_guess_clock_bound(graph_t *g) {
...
/* function definition
    ...
    calls:
*/
void tmg_guess_clock_bound_recursive(vertex_t *u, double *b1, double *b2) {
    lsGen    gen;
    edge_t   *e;
    vertex_t *v;
    int      den;
...
/* function definition
    ...
    calls:
*/
int tmg_all_negative_cycles(graph_t *g, double c) {
    vertex_t *v, *u;
    edge_t   *e;
    int      num_v, flag, i;
    double   C[2], c_eps, val;
...
graph_t *tmg_construct_clock_graph(graph_t *lg, double clock_lb) {
    graph_t  *cg;
    lsGen    gen;
    vertex_t *u, *p1, *v;
    edge_t   *e;
...
void tmg_gen_constraints_from(graph_t *lg, graph_t *cg, array_t *latch_array,
...
/* function definition
    ...
    calls:    g_get_edge()
*/
void tmg_add_short_path_constraints(graph_t *cg, graph_t *lg) {
    edge_t   *cedge, *ledge;
    double   **array;
    lsGen    gen;
...
double tmg_solve_constraints(graph_t *cg, vertex_t *v0, double clock_lb) {
...
*/
int tmg_is_feasible(graph_t *g, double c, vertex_t *v0) {
    edge_t   *e;
    vertex_t *u, *v;
    lsGen    gen;
    int      num_it, flag, i;
...
/* function definition
    ...
    calls:-
*/
void tmg_print_constraint_graph(graph_t *g) {
    edge_t       *e;
    vertex_t     *u, *v;
    char         *dummy;
    st_generator *sgen;
...
void tmg_add_model_constraints(graph_t *lg, graph_t *cg, register vertex_t *v0) {
    lsGen    gen;
    vertex_t *v;
...
/* function definition
    ...
    calls:
*/
void tmg_add_phase_separation_constraints(graph_t *lg, graph_t *cg, vertex_t *v0) {
...
/* function definition
    ...
    calls:
*/
void tmg_evaluate_right_hand_side(graph_t *g, double c) {
    lsGen        gen;
    edge_t       *e;
    char         *dummy;
    double       *value, C[2];
...
/* function definition
    ...
    calls:
*/
void tmg_print_constraints(graph_t *g) {
    lsGen    gen;
    edge_t   *e;
    vertex_t *u, *v;
...
void tmg_print_graph_solution(graph_t *g) {
    lsGen    gen;
    vertex_t *u;
...
/* function definition
    ...
    calls:
*/
void tmg_circuit_clock_update(graph_t *lg, graph_t *cg, network_t *network, double clock) {
    lsGen        gen;
    vertex_t     *u;
...
*/
double tmg_solve_gen_constraints(graph_t *cg, vertex_t *v0, double clock_lb) {
...
/* function definition
   ...
   tmg_evaluate_matrix()
*/
int tmg_exterior_path_search(graph_t *cg, double *clock, double L, double R) {
    int               num_v, flag;
...
/* function definition
    ...
    calls:
*/
matrix_t *tmg_init_matrix(graph_t *g, double c) {
    lsGen        gen;
    vertex_t     *v;
    matrix_t     *m;
    int          num_v;
...
/* function definition
    ...
    calls:
*/
void tmg_evaluate_matrix(graph_t *g, matrix_t *m, double c) {
    lsGen        gen;
    edge_t       *e;
    char         *dummy;
    st_generator *sgen;
...
int tmg_update_matrix(matrix_t *m) {
    int          flag, num_v;
    register int i, j;
    double       c;
...
/* function definition
    ...
    calls:
*/
void tmg_free_matrix(matrix_t *m) {
    int num_v, i;
