...
static int check_rect_value(A, col_cost, row_cost, rect) sm_matrix *A;
...
static sm_col *find_max_col_intersection(A, col_cost, rect,
                                         row_values) sm_matrix *A;
array_t *col_cost;
rect_t *rect;
int *row_values;
{
...
rect_t *greedy_col(A, col_cost, row_cost, seed) sm_matrix *A;
array_t *col_cost, *row_cost;
sm_col *seed;
{
  sm_element *p;
