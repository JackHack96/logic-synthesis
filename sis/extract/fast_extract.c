...
void fx_node_to_sm(node, M) register node_t *node;
...
node_t *fx_sm_to_node(func) sm_matrix *func;
{
  int i, nin;
...
/* Divide each fanout */
static int fx_divide_each_fanout(fanout, newnode, complement) array_t *fanout;
node_t *newnode;
int complement;
{
...
static rect_t *D112_to_S2(B, divisor) sm_matrix *B;
ddivisor_t *divisor;
{
  rect_t *rect;
...
static int calc_weight_D112(B, divisor) sm_matrix *B;
ddivisor_t *divisor;
{
  sm_col *col1, *col2, *col3;
  register int col_num1 = divisor->cube1->first_col->col_num;
 ...
 */
static ddivisor_t *choose_best_divisor(B, ddivisor_set, wdmax) sm_matrix *B;
lsList ddivisor_set;
int *wdmax;
{
  int maxweight = -1;
 ...
 */
int fx_compute_divisor_weight(func, divisor) sm_matrix *func;
ddivisor_t *divisor;
{
  int weight, w;
  lsGen gen;
...
static array_t *find_ddivisor_fanout(divisor) ddivisor_t *divisor;
{
  ddivisor_cell_t *dd_cell;
  ...
  st_foreach_item(fanout_table, gen, &key, NIL(char *)) {
...
static array_t *find_sdivisor_fanout(B, rect) sm_matrix *B;
rect_t *rect;
{
...
static void sd_update_matrix(B, rect) sm_matrix *B;
rect_t *rect;
{
 ...
 */
static void sd_reexpress(B, rect, dd112_on, index, newcolumn) sm_matrix *B;
rect_t *rect;
int dd112_on;
int index;
int *newcolumn;
 ...
 */
static array_t *dd_reexpress(B, divisor, node_index) sm_matrix *B;
ddivisor_t *divisor;
int *node_index;
{
  sm_matrix *func;
 ...
 */
static void dd_modify(B, div, node_index, newcubes, ddivisor_set) sm_matrix *B;
ddivisor_t *div;
int node_index;
array_t *newcubes;
 ...
 * divisor.
 */
static void sd_mod_old_divisor(divisor, ddivisor_set) ddivisor_t *divisor;
ddset_t *ddivisor_set;
{
...
static void sd_mod_new_divisor(divisor, ddivisor_set) ddivisor_t *divisor;
ddset_t *ddivisor_set;
{
  ddivisor_cell_t *cell;
  sm_row *cube, *base;
 ...
 * and a new divisor.
 */
static void sd_mod_INBETWEEN(dd_cell, ddivisor_set,
                             colnum) ddivisor_cell_t *dd_cell;
ddset_t *ddivisor_set;
int colnum;
{
 ...
 */
static void sd_mod_INDIVISOR(dd_cell, ddivisor_set) ddivisor_cell_t *dd_cell;
ddset_t *ddivisor_set;
{
...
int sd_check_affected(dd_cell, ddivisor_set,
                      newcolumn) ddivisor_cell_t *dd_cell;
ddset_t *ddivisor_set;
int newcolumn;
{
  ddivisor_t *divisor;
  ...
  case NONCHECK:
    con1 = (sm_row_find(dd_cell->cube1, newcolumn) == 0) ? 0 : 1;
 ...
 */
static void sd_modify(B, rect, ddivisor_set, newcolumn) sm_matrix *B;
rect_t *rect;
ddset_t *ddivisor_set;
int newcolumn;
{
...
static rect_t *sdiv_to_rect(B, sdiv) sm_matrix *B;
sdivisor_t *sdiv;
{
  rect_t *rect;
...
/* main program */
int fast_extract(B, ddivisor_set) sm_matrix *B;
ddset_t *ddivisor_set;
{
  int wdmax;
  ddivisor_t *divisor1;
