...
void kernel_extract(sm_matrix *A, int sis_index, int use_all_kernels) {
    sm_row *prow;
...
static int record_kernel(sm_matrix *co_rect, rect_t *rect, char *state) {
...
int sparse_kernel_extract(int value_threshold, int use_best_subkernel) {
    array_t    *fanout;
    sm_row     *kernel_cube;
    sm_matrix  *func;
    sm_element *p;
...
static void clear_kernel_rect(sm_matrix *A, rect_t *rect) {
...
int overlapping_kernel_extract(int value_threshold, int use_best_subkernel) {
...
static void overlapping_clear_rect(sm_matrix *A, rect_t *rect)
{
    register sm_element *p1, *p2, *p;
...
static void dump_literal(FILE *fp, int index)
{
...
static void dump_cube(FILE *fp, sm_row *cube)
{
    sm_element *p;
    int        first;
...
static void dump_fct(FILE *fp, sm_matrix *fct)
{
    sm_row *cube;
    int    first;
...
static void dump_kernel(FILE *fp, sm_row *kernel)
{
    sm_row     *kernel_cube;
    sm_element *p;
    int        first;
...
static void dump_subkernel(rect_t *rect)
{
