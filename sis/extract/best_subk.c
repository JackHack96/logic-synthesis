...
/* ARGSUSED */
static int best_subkernel_sop(sm_matrix *co_rect, register rect_t *rect, char *state_p) {
    register int           ks, cks;
...
/* ARGSUSED */
static int best_subkernel_factor(sm_matrix *co_rect, register rect_t *rect, char *state_p) {
    register sm_element    *p, *p1, *p2;
    st_table               *fanout;
    value_cell_t           *value_cell;
    best_subkernel_state_t *state;
...
static rect_t *best_subkernel(sm_matrix *kernel_cube_matrix, array_t *row_cost, array_t *col_cost, int (*func)()) {
    sm_row                 *prow;
    sm_element             *p;
    rect_t                 *rect;
    best_subkernel_state_t *state;
...
rect_t *choose_subkernel(sm_matrix *A, array_t *row_cost, array_t *col_cost, int option) {
    rect_t *rect = 0;
