...
static int check_rect_value(A, row_cost, col_cost, rect) sm_matrix *A;
...
static sm_row *find_max_row_intersection(A, row_cost, rect,
                                         col_values) sm_matrix *A;
array_t *row_cost;
rect_t *rect;
int *col_values;
{
...
rect_t *greedy_row(A, row_cost, col_cost, seed) sm_matrix *A;
array_t *row_cost, *col_cost;
sm_row *seed;
{
  sm_element *p;
