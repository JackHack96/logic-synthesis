...
static int row_value(prow, row_cost) sm_row *prow;
array_t *row_cost;
{
...
static sm_row *choose_row_seed(A, row_cost) sm_matrix *A;
array_t *row_cost;
{
...
static sm_row *choose_next_row_seed(A, row_cost, rect) sm_matrix *A;
array_t *row_cost;
rect_t *rect;
{
  register int value, max_value;
...
static int col_value(pcol, col_cost) sm_col *pcol;
array_t *col_cost;
{
  register sm_element *p;
  register int value;
...
static sm_col *choose_col_seed(A, col_cost) sm_matrix *A;
array_t *col_cost;
{
  register int value, max_value;
...
static sm_col *choose_next_col_seed(A, col_cost, rect) sm_matrix *A;
array_t *col_cost;
rect_t *rect;
{
  register int value, max_value;
...
static int update_best(rect1, rect2, best_rect) rect_t *rect1, *rect2,
    **best_rect;
{
  int got_new_best;
...
static rect_t *ping_pong_improve(A, row_cost, col_cost, best_rect) sm_matrix *A;
...
static rect_t *ping_pong_onepass(A, row_cost, col_cost) sm_matrix *A;
array_t *row_cost, *col_cost;
{
  sm_row *row_seed;
  sm_col *col_seed;
...
rect_t *ping_pong(A, row_cost, col_cost) sm_matrix *A;
array_t *row_cost, *col_cost;
{
  rect_t *best_rect;
