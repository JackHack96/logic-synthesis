...
static int com_cube_extract(network, argc, argv) network_t **network;
int argc;
char **argv;
{
  lsGen gen;
...
static int com_kernel_extract(network, argc, argv) network_t **network;
int argc;
char **argv;
{
  sm_matrix *func;
...
/* ARGSUSED */
static int print_kernel(kernel, co_kernel, state) node_t *kernel;
node_t *co_kernel;
char *state;
{
  (void)fprintf(sisout, "(");
...
static int com_print_kernel(network, argc, argv) network_t **network;
int argc;
char **argv;
{
  node_t *node;
...
static int com_gdiv(network, argc, argv) network_t **network;
int argc;
char **argv;
{
  node_t *node, *divisor;
...
static int com_fast_extract(network, argc, argv) network_t **network;
int argc;
char **argv;
{
  sm_matrix *cube_literal_matrix;
...
static st_table *find_required_time(network, max_level) network_t *network;
int max_level;
{
 ...
 */
static void remove_unwanted_nodes(network, level_table,
                                  required_table) network_t *network;
