...
void ex_setup_globals(network, dup_fcts) network_t *network;
...
void ex_setup_globals_single(node) node_t *node;
{
  int i;
  node_t *fanin;
...
void ex_free_globals(dup_fcts) int dup_fcts;
{
  int i;
  node_t *node1;
...
char *ex_map_index_to_name(i) int i;
...
void ex_node_to_sm(node, M) register node_t *node;
...
sm_matrix *ex_network_to_sm(network) network_t *network;
{
  node_t *node;
  sm_matrix *M;
  lsGen gen;
...
node_t *ex_sm_to_node(func) sm_matrix *func;
{
  int i, nin;
...
static int ex_divide_each_fanout(fanout, cubes, newnode, debug) array_t *fanout;
array_t *cubes;
node_t *newnode;
{
...
int ex_divide_function_into_network(func, fanout, cubes, debug) sm_matrix *func;
array_t *fanout;
array_t *cubes;
int debug;
{
