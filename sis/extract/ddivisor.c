...
void ddivisor_cell_free(ddivisor_cell_t *ddivisor_cell) { FREE(ddivisor_cell); }
...
static void table_cleanup(sm_matrix *table) {
    register sm_row     *row;
...
static void ddset_cleanup(ddset_t *ddivisor_set) {
    register sm_element *p;
    register sm_row     *row;
...
static int variable_count(ddivisor_t *divisor) {
    int count = 4;
    int i, j, t1[2], t2[2];
...
static int check_Dother(ddivisor_t *div1, ddivisor_t *div2) {
...
static int check_D222(ddivisor_t *div1, ddivisor_t *div2, int *phase) {
...
static int check_D223(ddivisor_t *div1, ddivisor_t *div2, int *phase) {
...
static lsList lookup_ddset(ddivisor_t *divisor, sm_matrix *table, int key1, int key2) {
...
static lsList lookup_ddset_other(ddivisor_t *divisor, sm_matrix *table) {
...
ddivisor_t *check_append(register ddivisor_t *div, ddset_t *ddivisor_set, ddivisor_cell_t *dd_cell) {
    int        phase = 0;
    ddivisor_t *dd;
    lsGen      gen;
 ...
 */
int extract_ddivisor(sm_matrix *B, int index, int row, ddset_t *ddivisor_set) {
    sm_row          *cube1, *cube2;
    sm_element      *pnode;
