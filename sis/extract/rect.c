...
static void gen_all_rect(sm_matrix *M, rect_t *rect, int col, int (*record)(), char *state) {
...
static int has_full_column(sm_matrix *M) {
...
void gen_all_rectangles(sm_matrix *M, int (*record)(), char *state) {
    rect_t *rect;
