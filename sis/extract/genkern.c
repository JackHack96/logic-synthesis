...
void ex_kernel_gen(node_t *node, int (*func)(), char *state) {
    sm_matrix          *node_func;
...
static int gen_kernels_got_one(sm_matrix *co_rect, register rect_t *rect, char *state_p) {
...
void ex_subkernel_gen(node_t *node, int (*func)(), int level, char *state) {
    sm_matrix          *node_func;
    gen_kernel_state_t *my_state;
...
/* ARGSUSED */
static int gen_subkernels_got_one(sm_matrix *co_rect, register rect_t *rect, char *state_p) {
    gen_kernel_state_t *state;
    node_t             *kernel, *cokernel;
