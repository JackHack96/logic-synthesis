...
node_t *decomp_quick_kernel(node_t *f) { return ex_find_divisor_quick(f); }

node_t *decomp_good_kernel(node_t *f) { return ex_find_divisor(f, 1, 1); }

node_t *dec_node_cube(node_t *f, int i) {
    node_cube_t cube;
