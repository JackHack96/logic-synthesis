...
void decomp_tech_network(network, and_limit, or_limit) network_t *network;
...
static void decomp_and_or(network, f) network_t *network;
node_t *f;
{
  node_t *g, *t, *clit, *c;
  int i;
...
static void balanced_tree(n, m, node_func, root, nodes,
