...
int read_line(fp, linep, lenp) FILE *fp;
char **linep;
int *lenp;
{
  int count, c;
 ...
 */
static int read_blif_loop(fp, models, search_files, first_network) FILE *fp;
 ...
 */
int read_blif(fp, networkp) FILE *fp;
network_t **networkp;
{
  int status;
 ...
 * lib_read_blif().
 */
int read_blif_first(fp, networkp) FILE *fp;
network_t **networkp;
{
  int i;
 ...
 */
static int read_node_list(network, list) network_t *network;
node_t ***list;
{
  int nlist, list_max;
  char *word;
 ...
 */
static int read_cover(fp, node, fanin, ninput, linep, lenp) FILE *fp;
node_t *node;
node_t **fanin;
int ninput;
 ...
 */
static int read_wordlist(wordlist) char ***wordlist;
{
  int i = 0;
  int list_max = 10;
  char *word;
 ...
 */
static int read_blif_subckt(network, models) network_t *network;
st_table *models;
{
 ...
 */
static int read_blif_gate(network, is_mlatch) network_t *network;
int is_mlatch;
{
 ...
 */
static int read_blif_latch(network) network_t *network;
{
  int n_params, value;
  char **word_list;
...
static int read_blif_clock(network) network_t *network;
{
  int i, nlist;
  node_t *node;
  char **word_list;
...
static int read_blif_clock_event(network) network_t *network;
{
...
static int read_blif_code(network) network_t *network;
{
  int nlist;
  char **word_list;
  graph_t *stg;
