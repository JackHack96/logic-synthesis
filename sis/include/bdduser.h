...
extern void cmu_bdd_overflow_closure(cmu_bdd_manager,
                                     void (*)(cmu_bdd_manager, pointer),
                                     pointer);

extern void cmu_bdd_abort_closure(cmu_bdd_manager,
...
extern bdd bdd_apply2(cmu_bdd_manager,
...
extern void cmu_bdd_print_profile(cmu_bdd_manager, bdd,
                                  char *(*)(cmu_bdd_manager, bdd, pointer),
                                  pointer, int, FILE *);

extern void cmu_bdd_print_profile_multiple(cmu_bdd_manager, bdd *,
                                           char *(*)(cmu_bdd_manager, bdd,
                                                     pointer),
                                           pointer, int, FILE *);

extern void cmu_bdd_print_function_profile(cmu_bdd_manager, bdd,
                                           char *(*)(cmu_bdd_manager, bdd,
                                                     pointer),
                                           pointer, int, FILE *);

extern void cmu_bdd_print_function_profile_multiple(cmu_bdd_manager, bdd *,
...
extern void cmu_bdd_dynamic_reordering(cmu_bdd_manager,
...
extern void mtbdd_transform_closure(
...
extern void cmu_mtbdd_terminal_value(cmu_bdd_manager, bdd, INT_PTR *,
                                     INT_PTR *);
