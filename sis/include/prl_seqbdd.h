...
extern bdd_t *Prl_ProductComputeNextStates(bdd_t *, seq_info_t *, prl_options_t *);

extern bdd_t *Prl_ProductReverseImage(bdd_t *, seq_info_t *, prl_options_t *);

extern array_t *Prl_ProductExtractNetworkInputNames(seq_info_t *, prl_options_t *);
...
extern int Prl_VerifyEnvFsm(network_t *, network_t *, network_t *, prl_options_t *);
