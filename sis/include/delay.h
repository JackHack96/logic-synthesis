...
extern delay_time_t delay_fanout_contribution(node_t *, int, node_t *, delay_model_t);

extern int delay_wire_required_time(node_t *, int, delay_model_t, delay_time_t *);
