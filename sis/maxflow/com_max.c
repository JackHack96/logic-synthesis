...
/* ARGSUSED */
void com_maxflow(network_t **network, int argc, char **argv) {
    maxflow_debug = 1 - maxflow_debug;
}

/* ARGSUSED */
void com_test_mf(network_t **network, int argc, char **argv) {
    int         i, j;
    mf_graph_t  *graph;
    mf_cutset_t *cutset;
    mf_node_t   *node;
...
/* ARGSUSED */
int com__run_maxflow(network_t **network, int argc, char **argv) {
    int         i, j, cap;
    FILE        *input;
    char        s[MAXLINE];
