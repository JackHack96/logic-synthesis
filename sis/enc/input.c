...
int filter_cons(char *file1, char *file2) {
    FILE *fp, *fpout;
    char *line, *symbols;
    int  iter, i, n;
    bool *used;
...
int read_cons(char *file, dic_family_t **dic_list) {
    FILE         *fp;
    dic_family_t *list;
    pset         lhs_set, dic;
...
dic_family_t *gen_uniq(dic_family_t *list) {
    dic_family_t *new;
...
dic_family_t *reduce_seeds(dic_family_t *list) {
