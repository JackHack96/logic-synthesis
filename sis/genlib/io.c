...
void gl_table_by_level(s_max, p_max) int s_max, p_max;
{
  int n, s, p, num;
...
void gl_table_of_gate_count(s_max, p_max) {
  int s, p, level, num;
...
void gl_table_of_nand_forms(s_max, p_max) int s_max, p_max;
{
  int s, p, level, num;
...
int gl_num_leafs(tree) tree_node_t *tree;
{
  int i, sum;
...
void gl_print_all_gates_genlib(level, s, p, invert_output) int level, s, p,
    invert_output;
{
...
void gl_print_all_gates(level, s, p) int level, s, p;
{
  tree_node_t **list, *tree;
  int i, nlist;
...
void gl_print_all_nand_forms(level, s, p, use_nor_gate, invert_output) int level
    ,
    s, p;
...
int gl_number_of_nand_forms(level, s, p) {
...
void gl_print_nand_forms(string, use_nor_gate) char *string;
int use_nor_gate;
{
  int i, nlist;
  tree_node_t **list, *tree;
