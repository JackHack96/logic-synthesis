...
static int leaf_compare(t1, t2) char **t1, **t2;
{
...
int gl_convert_gate_to_blif(name, area, function, pins, use_nor) char *name;
double area;
function_t *function;
pin_info_t *pins;
int use_nor;
...
/* sequential support */
int gl_convert_latch_to_blif(name, area, function, pins, use_nor, latch, clock,
...
static int check_internal_phase(tree, level) tree_node_t *tree;
int level;
{
  int i;
...
static int set_functions(tree, use_nor) tree_node_t *tree;
int use_nor;
{
  int i;
