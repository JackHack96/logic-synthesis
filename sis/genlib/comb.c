...
combination_t *gl_init_gen_combination(value, n) int *value;
int n;
{
  int i;
  combination_t *comb;
...
void gl_free_gen_combination(comb) combination_t *comb;
{
  FREE(comb->value);
  FREE(comb->state);
  FREE(comb);
...
int gl_next_combination(comb, vector) combination_t *comb;
int **vector;
{
  int k;
...
int gl_next_nondecreasing_combination(comb, vector) combination_t *comb;
int **vector;
{
  int k, nondecreasing;
...
int gl_next_nonincreasing_combination(comb, vector) combination_t *comb;
int **vector;
{
  int k, nonincreasing;
...
partition_t *gl_init_gen_partition(s) int s;
{
  int i;
  partition_t *part;
...
void gl_free_gen_partition(part) partition_t *part;
{
  FREE(part->value);
  FREE(part);
}

int gl_next_partition_less_than(part, value, n) partition_t *part;
...
int gl_next_partition(part, value, n) partition_t *part;
int **value;
int *n;
{
