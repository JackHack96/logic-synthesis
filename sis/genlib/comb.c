...
combination_t *gl_init_gen_combination(int *value, int n) {
    int           i;
    combination_t *comb;
...
void gl_free_gen_combination(combination_t *comb) {
    FREE(comb->value);
    FREE(comb->state);
    FREE(comb);
}

int gl_next_combination(combination_t *comb, int **vector) {
    int k;
...
int gl_next_nondecreasing_combination(combination_t *comb, int **vector) {
    int k, nondecreasing;
...
int gl_next_nonincreasing_combination(combination_t *comb, int **vector) {
    int k, nonincreasing;
...
partition_t *gl_init_gen_partition(int s) {
    int         i;
    partition_t *part;
...
void gl_free_gen_partition(partition_t *part) {
    FREE(part->value);
    FREE(part);
}

int gl_next_partition_less_than(partition_t *part, int **value, int *n) {
    int k, l, new_value;
...
int gl_next_partition(partition_t *part, int **value, int *n) {
