...
static void set_node_type(tree, type) tree_node_t *tree;
...
static void gl_write_blif_tables(fp, tree, use_nor_gate) register FILE *fp;
tree_node_t *tree;
int use_nor_gate;
{
  register int i;
...
static void gl_write_blif_inputs(fp, tree, latch) FILE *fp;
tree_node_t *tree;
...
void gl_write_blif(fp, tree, use_nor_gate, latch) FILE *fp;
tree_node_t *tree;
int use_nor_gate;
latch_info_t *latch; /* sequential support */
{
...
static array_t *make_tree_recur(leafs, nleafs, level) tree_node_t **leafs;
int nleafs;
int level;
{
  int i, j, k;
...
static void make_tree(list_in, n, state_in) char **list_in;
int n;
char *state_in;
{
...
static int gl_nand_gate_forms_recur(tree, list, use_nor_gate) tree_node_t *tree;
tree_node_t ***list;
int use_nor_gate;
{
...
int gl_nand_gate_forms(tree, list, use_nor_gate) tree_node_t *tree;
tree_node_t ***list;
int use_nor_gate;
{
