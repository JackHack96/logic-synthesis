...
static void strfree(thing) gGeneric thing;
{ FREE(thing); }
...
static void edge_free(thing) gGeneric thing;
{ FREE(((gGeneric *)thing)[2]); }

static gGeneric edge_copy(thing) gGeneric thing;
{
...
static int reverso(a, b) char *a, *b;
