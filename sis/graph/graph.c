...
void g_free(graph_t *g, void (*f_free_g)(), void (*f_free_v)(), void (*f_free_e)()) {
    lsGen    gen;
    vertex_t *v;
    edge_t   *e;
...
graph_t *g_dup(graph_t *g, gGeneric (*f_copy_g)(), gGeneric (*f_copy_v)(), gGeneric (*f_copy_e)()) {
    graph_t  *new;
...
array_t *g_graph_sort(graph_t *g, int (*cmp)()) {
    int      i;
    lsGen    gen;
    vertex_t *v;
    array_t  *v_array;
...
void g_delete_edge(edge_t *e, void (*f_free_e)()) {
    lsGeneric junk;
...
void g_delete_vertex(vertex_t *v, void (*f_free_v)(), void (*f_free_e)()) {
    edge_t    *e;
    lsGeneric junk;
    lsGen     gen;
