...
static vertex_t *find_an_end_vertex(v, visit_list) vertex_t *v;
st_table *visit_list;
{
  edge_t *e;
  vertex_t *dest;
...
static int dfs_recurr(v, dfs_list, dfs_array) vertex_t *v;
st_table *dfs_list;
array_t *dfs_array;
{
  edge_t *e;
...
static array_t *g_dfs_int(g) graph_t *g;
{
  vertex_t *v;
  lsGen gen;
  array_t *dfs_array;
