...
int util_save_image(orig_file_name, save_file_name) char *orig_file_name;
char *save_file_name;
{
...
static int copy_file(inFd, outFd, nbytes) int inFd, outFd;
...
static int pad_file(outFd, nbytes) int outFd;
int nbytes;
{
  char buf[BUFSIZE];
  int nzero;
