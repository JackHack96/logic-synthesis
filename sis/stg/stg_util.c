...
void stg_dump_graph(graph_t *graph, network_t *network) {
    lsGen    gen, gen2;
    vertex_t *re_no;
    node_t   *node;
    edge_t   *re_ed;
...
static array_t *stg_assign_names(int flag, int n) {
    int     i;
...
int stg_save_names(network_t *network, graph_t *stg, int print_error) {
    char         *name;
    lsGen        gen;
    node_t       *node;
    array_t      *name_array;
 ...
 */
static void stg_change_dc_node_name(network_t *dcnet, node_t *node, char *name) {
    node_t *dc_node;
 ...
 */
void stg_set_network_pipo_names(network_t *network, graph_t *stg) {
    int       i;
    int       modify_names;
    lsGen     gen;
    graph_t   *stg1;
