...
int stg_statecmp(key1, key2) char *key1, *key2;
{
  int equal_parts, i;
 ...
 */
int stg_statehash(key, modulus) char *key;
int modulus;
{
...
void stg_translate_hashed_code(h_state, stg_state) unsigned *h_state;
int *stg_state;
{
  int i, j, k;
...
static int is_state(cid, obj, level) int cid;
ndata **obj;
int *level;
{
  node_t *node;
...
static ndata *find_hardest_control(cid, node, noinv) int cid;
node_t *node;
int *noinv;
{
  register int i;
...
static ndata *find_easiest_control(cid, node, noinv) int cid;
node_t *node;
int *noinv;
{
  register int i;
 ...
 */
static ndata *find_pi_assignment(cid, obj, level) int cid;
ndata *obj;
int level;
{
  ndata *n;
...
static void save_edge(cid, stg) int cid;
graph_t *stg;
{
  char *b1, *b2;
  register char *t1, *t2;
...
void ctable_enum(stg) graph_t *stg;
{
...
unsigned *shashcode(estate) int *estate;
{
...
void enumerate(elength, estate, stg) int elength;
int *estate;
graph_t *stg;
{
