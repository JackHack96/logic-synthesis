...
-------------------------------------------------------*/
ite_vertex *act_ite_create_from_factored_form(node_t *node, act_init_param_t *init_param) {
    ...
    if (node_num_literal(node) == factor_num_literal(node))
    ...
    for (i  = 0; i < array_n(nodevec); i++) {
        ...
        /* change node, value fields in the ites which are either buffers or
         * inverters */
        /*-----------------------------------------------------------------------------*/
...
----------------------------------------------------------*/
int act_ite_map_factored_form(node_t *node, act_init_param_t *init_param) {
...
----------------------------------------------------------------------*/
void act_ite_correct_PIs(ite_vertex *ite, node_t *node) {
    network_t  *network;
    ite_vertex *vertex;
    int        i, j, flag;
    node_t     *n;
...
-----------------------------------------------------------*/
void act_ite_get_value_2_vertices(ite_vertex *ite, array_t *vertex_vec, st_table *table) {
