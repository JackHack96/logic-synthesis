...
-------------------------------------------------------*/
ite_vertex *act_ite_create_from_factored_form(node, init_param) node_t *node;
...
----------------------------------------------------------*/
int act_ite_map_factored_form(node, init_param) node_t *node;
act_init_param_t *init_param;
{
...
----------------------------------------------------------------------*/
act_ite_correct_PIs(ite, node) ite_vertex *ite;
node_t *node;
{
  network_t *network;
  ite_vertex *vertex;
...
-----------------------------------------------------------*/
act_ite_get_value_2_vertices(ite, vertex_vec, table) ite_vertex *ite;
array_t *vertex_vec;
st_table *table;
{
