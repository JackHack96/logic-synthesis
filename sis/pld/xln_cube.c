...
------------------------------------------------------------------------*/
xln_network_ao_map(network, size) network_t *network;
int size;
{
  array_t *nodevec;
  int num, i;
...
/*------------------------------------------------------------------------
  ...
  also.
-------------------------------------------------------------------------*/
xln_node_ao_map(node, size) node_t *node;
int size;
{
...
-------------------------------------------------------------------------*/
xln_extract_big_ands_from_cube(network, node, cube, size) network_t *network;
node_t *node;
node_cube_t cube;
int size;
{
...
/*------------------------------------------------------------------------
  ...
  ------------------------------------------------------------------------*/
node_t *xln_make_big_and(one_array, zero_array, num_one,
                         num_zero) array_t *one_array,
    *zero_array;
...
-----------------------------------------------------------------------*/
xln_ao_replace_node_with_tlus(network, node, size) network_t *network;
node_t *node;
int size;
{
...
/*-----------------------------------------------------------------------
  ...
  2) After all cubes in pcubevec have been thus processed, the tlu's
     ...
     different fanin).
-------------------------------------------------------------------------*/
int xln_make_tlus(network, node, pcubevec, ptluvec, size) network_t *network;
node_t *node;
...
int xln_ao_compare(pn1, pn2) node_t **pn1, **pn2;
{
  int num1, num2;
...
-----------------------------------------------------------------------*/
int xln_is_cube_absorbed(cube_node, tluvec, size) node_t *cube_node;
array_t *tluvec;
int size;
{
