...
void xln_absorb_nodes_in_fanins(network_t *network, int support) {
    array_t *Y, *Z;
    array_t *nodevec;
    array_t *decomp_vec;
    int     i, j, k;
...
--------------------------------------------------------------------------------*/
array_t *xln_can_node_be_absorbed_in_fanins(node_t *node, int support, array_t **pY, array_t **pZ) {
...
----------------------------------------------------------------------*/
int xln_num_union_of_fanins(array_t *nodevec) {
    st_table *table;
    int      i, j;
...
void xln_generate_all_fanin_combinations(node_t *node, array_t *pY, array_t *pZ) {
    int     num_fanin;
    int     num_comb;
    char    *encoded_char;
    int     i, l;
...
/*----------------------------------------------------------------------
  ...
  i.
-----------------------------------------------------------------------*/
void xln_generate_fanin_combination(node_t *node, int i, array_t *Y, array_t *Z) {
    int    num_fanin;
    char   *encoded_char;
    int    l;
    node_t *fanin;
...
void xln_print_absorb_node(node_t *node, array_t *Y, array_t *Z) {
    int    i;
    node_t *fanin;
...
int xln_num_internal_nodes(array_t *nodevec) {
    int    sum;
    int    i;
    node_t *node;
