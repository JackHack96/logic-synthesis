...
static act_t *urp_F(F) sm_matrix *F;
{
  int b_col, ex;
...
static void split_F(F, b_col, Fl, Fr) sm_matrix *F, **Fl, **Fr;
int b_col;
{
  sm_matrix *Fhi, *Flo;
  sm_row *F_row;
...
my_sm_copy_row(F_row, F, col, Fp) sm_row *F_row;
sm_matrix *F, *Fp;
int col;
{
  int j;
