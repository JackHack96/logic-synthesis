...
ite_vertex *ite_new_ite_for_cubenode(node) node_t *node;
{
  array_t *order_list;
  int i;
  node_t *fanin;
...
ite_vertex *ite_new_ite_for_single_literal_cubes(node) node_t *node;
{
...
ite_vertex *ite_new_ite_and(vertex, fanin, phase) ite_vertex *vertex;
node_t *fanin;
input_phase_t phase;
{
...
/* Or variables */
ite_vertex *ite_new_ite_or(vertex, fanin, phase) ite_vertex *vertex;
node_t *fanin;
input_phase_t phase;
{
  ite_vertex *vertex_IF, *p_vertex;
...
-----------------------------------*/
ite_vertex *ite_new_literal(fanin) node_t *fanin;
{
  ite_vertex *ite;
