    ...
    if (vertex == NIL(ite_vertex)) {
        switch (phase) {
            ...
            case NEG_UNATE: p_vertex = my_shannon_ite(vertex_IF, ite_0, ite_1);
                break;
            case BINATE:;
            case PHASE_UNKNOWN: (void) fprintf(misout, "error in new_my_ite_and():phase is binate or unknown\n");
                exit(1);
        }
    } else {
        switch (phase) {
            ...
            case NEG_UNATE:p_vertex = my_shannon_ite(vertex_IF, ite_0, vertex);
                break;
            case BINATE:;
            case PHASE_UNKNOWN: (void) fprintf(misout, "error in new_my_and act, phase is binate or unknown\n");
                exit(1);
        }
    }
    return p_vertex;
    ...
    if (vertex == NIL(ite_vertex)) {
        switch (phase) {
            ...
            case NEG_UNATE: p_vertex = my_shannon_ite(vertex_IF, ite_0, ite_1);
                break;
            case BINATE:;
            case PHASE_UNKNOWN: (void) fprintf(misout, "error in new_my_ite_or():phase is binate or unknown\n");
                exit(1);
        }
    } else {
        switch (phase) {
            ...
            case NEG_UNATE:p_vertex = my_shannon_ite(vertex_IF, vertex, ite_1);
                break;
            case BINATE:;
            case PHASE_UNKNOWN: (void) fprintf(misout, "error in new_my_or act, phase is binate or unknown\n");
                exit(1);
        }
    }
    return p_vertex;
