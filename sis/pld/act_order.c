...
enum st_retval p_addPI(char *key, char *value, char *arg) {
    node_t         *node;
    int            level;
    array_t        *pi_list;
    fanin_record_t *pi_record;
...
array_t *pld_order_nodes(array_t *node_vec, int pi_only) {
    node_t   *dummy_node, *t_node, *tt_node, *root, *node;
    int      i;
    char     *dummy;
...
void p_rootAdd(node_t *node, st_table *root_table) {
    char    *dummy;
...
void p_levelAdd(node_t *node, st_table *level_table, st_table *root_table) {
    char   *dummy;
...
int p_maxAdd(node_t *node, st_table *max_table, st_table *level_table, st_table *root_table) {
    char   *dummy;
    int    i, max, fanin_max;
    node_t *fanin;
...
void p_recOrder(node_t *node, st_table *max_table, st_table *fanin_table, st_table *root_table, array_t *order_list,
                int pi_only) {
...
/*ARGSUSED*/
enum st_retval p_cleanRTable(char *key, char *value, char *arg) {
    st_table *root_table;
    node_t   *node;
...
void p_recFree(node_t *node, st_table *root_table) {
    char    *dummy;
    node_t  *fanin;
    int     i;
    array_t *fanin_list;
...
int p_fanin_record_sort(char **key1, char **key2) {
...
/*ARGSUSED*/
enum st_retval p_cleanFRTable(char *key, char *value, char *arg) {
    fanin_record_t *fanin_record;
