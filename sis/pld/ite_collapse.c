...
unsuccessfully.
------------------------------------------------------------------------------------*/
int act_ite_partial_collapse(network, init_param) network_t *network;
...
int act_ite_partial_collapse_node(network, node, init_param, pgain,
...
int act_ite_partial_collapse_node_new(network, node, init_param, pgain,
                                      score_table) network_t *network;
node_t *node;
act_init_param_t *init_param;
int *pgain;
...
int act_ite_partial_collapse_assign_score_node(node, score_table,
...
-------------------------------------------------------------*/
static node_t *
    act_ite_partial_collapse_find_max_score(network, score_table,
...
int act_ite_partial_collapse_assign_score_network(
    network, score_table, init_param) network_t *network;
st_table *score_table;
act_init_param_t *init_param;
{
  array_t *nodevec;
...
act_ite_partial_collapse_put_node_names_in_ite(ite, network) ite_vertex *ite;
network_t *network;
{
  st_table *table;
  char *key;
