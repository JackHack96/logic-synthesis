...
unsuccessfully.
------------------------------------------------------------------------------------*/
int act_partial_collapse_without_lindo(network_t *network, st_table *cost_table, act_init_param_t *init_param) {
...
int act_partial_collapse_node(network_t *network, node_t *node, st_table *cost_table, act_init_param_t *init_param,
                              int *pgain, st_table *score_table) {
...
int act_partial_collapse_assign_score_node(node_t *node, st_table *score_table, st_table *cost_table,
...
-------------------------------------------------------------*/
static node_t *act_partial_collapse_find_max_score(network_t *network, st_table *score_table, int *pscore) {
    lsGen  gen;
...
---------------------------------------------------------------------------------*/
int act_partial_collapse_assign_score_network(network_t *network, st_table *score_table, st_table *cost_table,
                                              act_init_param_t *init_param) {
    array_t *nodevec;
