...
***************************************************************************/
array_t *act_read_delay(filename) char *filename;
{
...
print_delay_values(delay_values) array_t *delay_values;
{
  int i, nsize;
  double delaynum;
