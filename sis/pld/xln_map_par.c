...
void form_suppress_matrix(sm_matrix *matrix, array_t *sepset_array) {
    int     i, j;
...
int squeeze_matching(sm_row *row) {
    sm_element *element;
    node_t     *node;
    int        maxflow;
...
void generate_matching(array_t *sink_array, array_t *sepset_array, int count) {
...
void DFS_covered_node(node_t *node, array_t *node_array, int *flag) {
...
void form_binate_matrix(network_t *network, sm_matrix *matrix, int *weight,
                        array_t *sink_array, array_t *sepset_array,
                        int *pbasic_num_rows) {
...
node_t *partial_collapse_node(node_t *sink, array_t *sepset_node_array) {
...
network_t *partial_collapse(array_t *sink_array, array_t *sepset_array) {
...
void partition_network(network_t *network_in, int n, int bincov_heuristics) {
...
sm_row *sm_mat_bin_minimum_cover_greedy(sm_matrix *matrix, int *weight,
...
sm_col *get_column_with_max_elements(sm_matrix *matrix) {
    sm_col *pcol;
    sm_col *best_col;
    int    MAX_ELEMENTS;
    int    colnum;
...
************************************************************************************/
void select_column_and_update_matrix(sm_matrix *matrix) {
...
/**********************************************************************************
  ...
  in the binate cover.
***********************************************************************************/
sm_row *sm_generate_row(array_t *solution_array) {
...
----------------------------------------------------------------------------*/
sm_row *sm_mat_bin_minimum_cover_my(sm_matrix *matrix, int *weight,
                                    int bincov_heuristic, int basic_num_rows) {
...
-------------------------------------------------------------------*/
int xln_seq_check_row_elements_even(sm_row *row) {
    sm_element *p;
...
---------------------------------------------------------------------*/
void sm_mat_bin_minimum_cover_nonbasic(sm_matrix *matrix, sm_row *row_solution,
                                       st_table *table) {
...
-----------------------------------------------------------------------*/
sm_col *sm_get_even_column_with_max_score(sm_matrix *matrix) {
...
---------------------------------------------------------------*/
void xln_seq_table_of_rows_covered_by_odd_columns(sm_matrix *matrix,
                                                  st_table *table) {
    sm_col     *col;
    sm_element *p;
