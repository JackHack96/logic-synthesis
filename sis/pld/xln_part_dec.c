...
void split_network(network_t *network, int size) {
    array_t *order;
    node_t  *node;
    int     i;
    char    *err;
...
int split_node(network_t *network, node_t *node, int size) {
    int       i, value = 1;
    kern_node *sorted;
...
static void find_best_div(divisor_t *div, divisor_t *best_div, int size) {
...
int xln_infeasibility_measure(node_t *node, int size) {
