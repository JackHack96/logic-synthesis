...
array_t *array_disjoint(array_t *a, int s, st_table *t) {
    int     i, *n_out;
    int     j, k;
    array_t *new_a;
    sol_t   *sol;
...
int xln_comp(sol_t **o1, sol_t **o2) {
    sol_t *sol1, *sol2;
    sol1 = *o1;
    sol2 = *o2;
...
-------------------------------------------------------------------------------*/
int xln_do_trivial_collapse_network(network_t *network, int size, int MOVE_FANINS, int MAX_FANINS) {
    int num_collapsed;
    int changed;
...
int xln_do_trivial_collapse_network_one_iter(network_t *network, int size, int MOVE_FANINS, int MAX_FANINS) {
    int     num_collapsed;
    int     is_collapsed;
    int     i;
    array_t *nodevec;
...
-------------------------------------------------------------------------------*/
int xln_do_trivial_collapse_node(node_t *node, int size, int MOVE_FANINS, int MAX_FANINS) {
    int is_collapsed;
...
---------------------------------------------------------------------------*/
int xln_do_trivial_collapse_node_without_moving(node_t *node, int size) {
    int     j;
    array_t *fo_array;
    node_t  *fo, *fo_simpl;
    lsGen   gen;
...
static int cost_fanin(node_t *po, node_t *fanin) {
    node_t *fi;
    int    j, cost;
...
static int composite_fanin(node_t *node1, node_t *node2) {
    node_t *fi;
    int    inp, j;
