...
act_ite_iterative_improvement(network, init_param) network_t *network;
...
ite_improve_network(network, init_param) network_t *network;
act_init_param_t *init_param;
...
static void ite_decomp_big_nodes(network, gain, init_param) network_t *network;
int *gain;
act_init_param_t *init_param;
{
  array_t *nodevec;
...
network_t *act_ite_network_remap(network, init_param) network_t *network;
act_init_param_t *init_param;
{
  array_t *nodevec;
  node_t *node;
...
--------------------------------------------------------------------------*/
act_last_gasp(network, init_param) network_t *network;
act_init_param_t *init_param;
{
  array_t *nodevec;
  int i;
...
------------------------------------------------------------------------------------*/
int act_ite_node_remap(network, node, FLAG_DECOMP,
                       init_init_param) network_t *network;
node_t *node;
int FLAG_DECOMP;
...
act_ite_network_update_pi(node1_dup, node1, table1, network1) node_t *node1_dup,
    *node1;
st_table *table1;
network_t *network1;
{
...
int ite_print_network(network, iteration_num) network_t *network;
int iteration_num;
{
  lsGen gen;
  node_t *node;
...
------------------------------------------------------------------------------------*/
int act_ite_use_alternate_rep(node, init_param) node_t *node;
act_init_param_t *init_param;
{
