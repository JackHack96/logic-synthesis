...
int act_ite_new_map_node(node, init_param) node_t *node;
...
act_ite_intermediate_new_make_ite(node, init_param) node_t *node;
act_init_param_t *init_param;
{
  ite_vertex *ite;
...
act_ite_new_make_ite(node, init_param) node_t *node;
act_init_param_t *init_param;
{
...
/*-----------------------------------------------------------
  ...
  returned.
-------------------------------------------------------------*/
node_t *node_most_binate_variable(node) node_t *node;
{
...
node_t *node_most_binate_variable_new(node, init_param, pite) node_t *node;
act_init_param_t *init_param;
ite_vertex **pite;
{
...
-----------------------------------------------------------------------*/
node_t *ite_get_minimum_cost_variable(node, init_param) node_t *node;
act_init_param_t *init_param;
...
/*---------------------------------------------------------------------
   ...
   of node.
----------------------------------------------------------------------*/
ite_vertex *ite_convert_match_to_ite(node, match) node_t *node;
ACT_MATCH *match;
{
...
ite_vertex *ite_for_muxnode(control, zero, one) node_t *control, *zero, *one;
{
...
ite_vertex *ite_buffer(node) node_t *node;
{
...
ite_vertex *ite_inv(node) node_t *node;
{
...
ite_vertex *ite_get_vertex(node) node_t *node;
{
  node_function_t node_fun;
  ite_vertex *ite;
  node_t *fanin;
...
-----------------------------------------------------------------------*/
ite_vertex *ite_create_ite_for_orthogonal_cubes(node) node_t *node;
{
...
-----------------------------------------------------------------------*/
int ite_find_mux_remaining(p, q, count) int p, q, count;
{
  int q_3;
...
------------------------------------------------------------------------*/
pld_find_pos_neg_litcount_in_cube(cubenode, p, q) node_t *cubenode;
int *p, *q;
{
  int i;
  node_t *fanin;
...
---------------------------------------------------------------------*/
ite_interleave_muxfree_and_full(muxfree_ite_vec, full_ite_vec, m,
                                f) array_t *muxfree_ite_vec,
    *full_ite_vec;
...
ite_vertex *ite_new_OR(ite_a, ite_b) ite_vertex *ite_a, *ite_b;
{
  ite_vertex *ite;
...
----------------------------------------------------------------------*/
ite_vertex *ite_new_OR_with_inv(ite_a, ite_b) ite_vertex *ite_a, *ite_b;
{
  ite_vertex *temp, *ite;
...
int ite_is_inv(ite) ite_vertex *ite;
{
...
-------------------------------------------------------*/
int node_num_binate_variables(node) node_t *node;
{
  int i, num_binate = 0;
  node_t *fanin;
...
int ite_assign_var_weight(node, fanin, j, lit_count_array) node_t *node, *fanin;
...
int node_compute_binateness(node) node_t *node;
{
...
-------------------------------------------------------------------------------*/
int ite_assign_var_cost(node, fanin, init_param, min_cost_so_far) node_t *node,
    *fanin;
act_init_param_t *init_param;
int min_cost_so_far;
{
...
int node_is_unate(node) node_t *node;
{
  int i;
  node_t *fanin;
...
/* no changes needed */
static sm_matrix *build_F(node) node_t *node;
{
  int i, j;
  node_cube_t cube;
...
ite_vertex *ite_new_ite_for_unate_cover(node, init_param) node_t *node;
act_init_param_t *init_param;
{
