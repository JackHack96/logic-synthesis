...
-----------------------------------------------------------------------*/
xln_decomp_for_merging_network(network, init_param) network_t *network;
...
xln_decomp_for_merging_ALL_CUBES(nodevec, init_param) array_t *nodevec;
xln_init_param_t *init_param;
{
...
xln_decomp_for_merging_PAIR_NODES(nodevec, init_param) array_t *nodevec;
xln_init_param_t *init_param;
{
...
------------------------------------------------------------------------------*/
xln_decomp_for_merge_pair_of_nodes(n1, n2, init_param) node_t *n1, *n2;
xln_init_param_t *init_param;
{
  array_t *cube_node_vec;
  array_t *nodevec;
...
xln_decomp_for_merge_cube_nodes(cube_node_vec, cubenode2node_table,
                                node2cubenode_table,
                                init_param) array_t *cube_node_vec;
...
array_t *xln_node_find_common_inputs(node1, node2) node_t *node1, *node2;
{
...
----------------------------------------------------------------------------*/
xln_extract_mergeable_fns_from_cubes(n1, n2, affinity_struct, table,
                                     node2cubenode_table, init_param) node_t *n1
    ,
    *n2;
AFFINITY_STRUCT *affinity_struct;
...
---------------------------------------------------------------------------*/
node_t *xln_extract_supercube_from_cube(node, subset_common) node_t *node;
array_t *subset_common;
{
...
---------------------------------------------------------------------------*/
xln_add_more_literals(psub_node, node, fanin_bound_more, nc,
                      nc_ptr) node_t **psub_node,
    *node;
...
xln_free_AFFINITY_STRUCT(affinity_struct) AFFINITY_STRUCT *affinity_struct;
{
  array_free(affinity_struct->common);
...
-----------------------------------------------------------*/
int pld_affinity_compare_function(p1, p2) AFFINITY_STRUCT **p1, **p2;
{
  int num1, num2;
...
-----------------------------------------------------------------*/
array_t *xln_infeasible_nodes(network, support) network_t *network;
int support;
{
  array_t *nodevec;
  lsGen gen;
...
------------------------------------------------------------------------*/
array_t *xln_fill_tables(cubenode2node_table, node2cubenode_table, nodevec,
                         init_param) st_table *cubenode2node_table,
    *node2cubenode_table;
array_t *nodevec;
xln_init_param_t *init_param;
{
...
xln_free_cube_nodes(cube_node_vec) array_t *cube_node_vec;
{
  int i;
  node_t *cube_node;
...
---------------------------------------------------------------------------*/
xln_add_more_cubes(psub_node, cube_node, n, node2cubenode_table,
                   table) node_t **psub_node,
    *cube_node, *n;
...
xln_free_node2cubenode_table(node2cubenode_table) st_table *node2cubenode_table;
{
  char *key;
  st_generator *stgen;
  array_t *cubevec;
