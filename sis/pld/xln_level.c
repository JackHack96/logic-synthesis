...
----------------------------------------------------------------------------*/
xln_reduce_levels(net, init_param) network_t **net;
...
-----------------------------------------------------------------------------*/
int xln_one_pass_by_levels(network, threshold, init_param) network_t *network;
double threshold;
xln_init_param_t *init_param;
{
  int changed;
...
int xln_one_pass_topol(network, threshold, init_param) network_t *network;
double threshold;
xln_init_param_t *init_param;
{
  int changed;
...
----------------------------------------------------------------------------*/
int xln_node_collapse_if_critical(node, threshold, init_param) node_t *node;
double threshold;
xln_init_param_t *init_param;
{
  node_t *fanout, *fanin;
...
-----------------------------------------------------------------------------*/
xln_is_just_one_fanin_critical(fanout, comp_fanin, size, fanin) node_t *fanout;
array_t *comp_fanin;
int size;
node_t **fanin;
{
...
/*------------------------------------------------------
  ...
  node is critical.
-------------------------------------------------------*/
xln_is_node_critical(node, threshold) node_t *node;
double threshold;
{
...
xln_num_composite_fanin(n1, n2) node_t *n1, *n2;
{
...
array_t *xln_composite_fanin(n1, n2) node_t *n1, *n2;
{
  array_t *faninvec;
  node_t *fanin;
  int i;
...
xln_mux_decomp(fanoutvec, network, table, size) array_t *fanoutvec;
network_t *network;
st_table *table;
int size;
{
...
-----------------------------------------------------------------------------*/
int xln_try_collapsing_node(node, fanoutvec, init_param) node_t *node;
array_t *fanoutvec;
xln_init_param_t *init_param;
{
  int changed;
...
-----------------------------------------------------------------------------------*/
network_t *
    xln_check_network_for_collapsing_delay(network,
...
--------------------------------------------------------------*/
xln_cofactor_decomp_network(network, support, mode) network_t *network;
int support;
float mode;
{
  array_t *levelsvec, *levelvec;
...
----------------------------------------------------------------------*/
array_t *xln_array_of_levels(network) network_t *network;
{
  double max_level;
  int imax_level;
  array_t *levelsvec, *levelvec;
...
------------------------------------------------------------------------*/
array_t *xln_array_of_critical_nodes_at_levels(network,
                                               threshold) network_t *network;
double threshold;
{
  double max_level;
  int imax_level;
...
xln_level_width_compare_function(obj1, obj2) array_t **obj1, **obj2;
