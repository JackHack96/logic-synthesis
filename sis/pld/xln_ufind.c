...
void unionop(struct tree_node *node1, struct tree_node *node2) {
...
void make_son(struct tree_node *node1, struct tree_node *node2) {
    node1->parent    = node2;
...
struct tree_node *find_tree(struct tree_node *node) {
...
int estimate_clb_no(network_t *network, int size) {
    int       upper_bound;
