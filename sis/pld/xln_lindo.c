...
char *formulate_Lindo(sm_matrix *coeff) {
...
int get_Lindo_result(array_t *cand_node_array, sm_matrix *coeff, array_t *match1_array, array_t *match2_array,
                     char *lindo_out, FILE *outputFile) {
