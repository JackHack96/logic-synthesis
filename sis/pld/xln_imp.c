...
----------------------------------------------------------------------------*/
xln_selective_good_decomp(network, lit_limit, alpha) network_t *network;
int lit_limit;
float alpha;
{
...
xln_improve_network(network, init_param) network_t *network;
...
/*---------------------------------------------------------
  ...
  the new network.
----------------------------------------------------------*/
xln_improve_node(node, init_param) node_t *node;
xln_init_param_t *init_param;
{
  node_t *dup_node;
  network_t *network1;
...
-----------------------------------------------------------------------------*/
network_t *xln_best_script(node, init_param) node_t *node;
xln_init_param_t *init_param;
{
...
-------------------------------------------------------------*/
xln_cover_or_partition(network, init_param) network_t *network;
xln_init_param_t *init_param;
{
...
xln_network_print(network) network_t *network;
{
  int i, num;
  node_t *node;
  array_t *nodevec;
...
network_t *xln_cofactor_decomp(node, support, mode) node_t *node;
int support;
float mode;
{
  network_t *network;
...
------------------------------------------------------------------------*/
int xln_cofactor_decomp_node(node, support, mode) node_t *node;
int support;
float mode;
{
...
------------------------------------------------------------------*/
node_t *xln_select_fanin_for_cofactor_area(node) node_t *node;
{
  int num_cube;
  int *lit_count_arr;
  int j, jx2;
...
------------------------------------------------------------------*/
node_t *xln_select_fanin_for_cofactor_delay(node) node_t *node;
{
