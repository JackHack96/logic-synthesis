...
act_t *my_act_and(sm_element *p, act_t *vertex, char *name) {
    int   is_first = 0;
...
/* Or 2 ACT's*/
act_t *my_or_act_F(array_t *array_b, sm_row *cover, array_t *array) {
    int        i;
...
static void join(act_t *parent_vertex, act_t *vertex, act_t *down_vertex) {
...
act_t *my_and_act(act_t *act_l, act_t *act_r, int b_col, char *name) {
    act_t *act;
