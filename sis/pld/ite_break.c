...
act_ite_break_network(network, init_param) network_t *network;
...
----------------------------------------------------------------------------*/
int act_ite_break_node(node, init_param) node_t *node;
act_init_param_t *init_param;
{
...
***************************************************************************************/
node_t *act_ite_get_function(network, node, vertex) network_t *network;
node_t *node;
...
ite_set_MARK_VALUE_ite(ite) ite_vertex *ite;
{
...
---------------------------------------------------------------*/
ite_reset_mark_ite(ite) ite_vertex *ite;
{
  st_table *table;
  char *key;
  st_generator *stgen;
...
************************************************************************************/
ite_free_node_if_possible(node, vertex) node_t *node;
ite_vertex *vertex;
{
...
int act_new_act_break_node(node) node_t *node;
{
  network_t *network;
...
---------------------------------------------------------------*/
ite_check_ite(ite, node) ite_vertex *ite;
node_t *node;
{
  st_table *table;
  char *key;
...
all these nodes in the network. Original node is changed.
***************************************************************************************/
node_t *act_new_act_get_function(network, node, vertex) network_t *network;
node_t *node;
