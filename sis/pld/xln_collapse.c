...
xln_partial_collapse(network, init_param) network_t *network;
...
int xln_cost_of_node(node, cost_table) node_t *node;
st_table *cost_table;
{
...
assigned any values.
--------------------------------------------------------------------------------------------*/
int xln_partial_collapse_node(network, node, cost_table, init_param,
                              pgain) network_t *network;
node_t *node;
st_table *cost_table;
xln_init_param_t *init_param;
int *pgain;
...
xln_free_fo_table_without_freeing_key(fo_table) st_table *fo_table;
{
  st_generator *gen;
  char *key;
  network_t *network_node;
...
xln_collapse_remap(node, pnetwork, init_param) node_t *node;
network_t **pnetwork;
xln_init_param_t *init_param;
{
  network_t *network2;
...
--------------------------------------------------------------------*/
xln_collapse_check_area(pnetwork, init_param,
                        roth_karp_flag) network_t **pnetwork;
xln_init_param_t *init_param;
int roth_karp_flag;
{
  network_t *network1;
...
-----------------------------------------------------------------------------------*/
network_t *
    xln_check_network_for_collapsing_area(network, init_param,
                                          roth_karp_flag) network_t *network;
xln_init_param_t *init_param;
int roth_karp_flag;
{
