...
act_ite_map_network_with_iter(network, init_param) network_t *network;
...
act_ite_preprocess(network, init_param) network_t *network;
act_init_param_t *init_param;
{
  array_t *nodevec;
  int i;
...
------------------------------------------------------------------*/
act_ite_map_network(network, init_param) network_t *network;
act_init_param_t *init_param;
{
  array_t *nodevec;
  int i;
...
int act_ite_map_node(node, init_param) node_t *node;
act_init_param_t *init_param;
{
...
--------------------------------------------------------------------*/
int act_ite_make_tree_and_map(node) node_t *node;
...
int act_map_ite(vertex) ite_vertex_ptr vertex;
{
...
-------------------------------------------------------------------*/
int act_vertex_ite_complemented(vertex) ite_vertex_ptr vertex;
...
static void act_initialize_ite_area(vertex,
                                    multiple_fo_array) ite_vertex_ptr vertex;
array_t *multiple_fo_array;
{
...
--------------------------------------------------------------------*/
node_t **act_ite_order_fanins(node) node_t *node;
{
...
ite_free_cost_struct(cost_struct) ACT_ITE_COST_STRUCT *cost_struct;
{
...
------------------------------------------------------------------------*/
int act_bdd_make_tree_and_map(node, act_of_node) node_t *node;
ACT_VERTEX_PTR act_of_node;
