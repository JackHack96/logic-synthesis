...
static ite_vertex *urp_F(F, node) sm_matrix *F;
node_t *node;
{
...
static int good_bin_var(A, ex) sm_matrix *A;
int *ex;
...
static int find_var(o, z, size) int *o, *z, size;
{
...
void ite_split_F(F, b_col, F_THENELSE, F_THEN, F_ELSE) sm_matrix *F,
    **F_THENELSE, **F_THEN, **F_ELSE;
int b_col;
{
...
static void update_F(F, b_col) sm_matrix *F;
int b_col;
{
  sm_col *p_col;
  sm_element *p;
...
--------------------------------------------------------------------------------*/
int act_mux_inputs_special_case(F, a_col, b_col) sm_matrix *F;
int *a_col, *b_col;
{
...
------------------------------------------------------------------------------*/
sm_matrix *act_sm_complement_special_case(F, special_case, a_col,
                                          b_col) sm_matrix *F;
