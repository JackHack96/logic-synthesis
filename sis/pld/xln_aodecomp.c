...
int pld_decomp_and_or(network, f, size) network_t *network;
node_t *f;
int size;
{
  node_t *g, *t, *clit, *c;
...
static void decomp_and(network, f, and_limit) network_t *network;
node_t *f;
int and_limit;
{
...
static void decomp_or(network, f, or_limit) network_t *network;
node_t *f;
int or_limit;
{
  array_t *nodes, *leaves;
...
balanced_tree(n, m, node_func, root, nodes,
              leaves) int n; /* number of leaves */
