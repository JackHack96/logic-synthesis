...
com_act_ite_map(network, argc, argv) network_t **network;
int argc;
char **argv;
{
  int c;
...
com_act_ite_create_and_map_mroot_network(network, argc,
...
com_act_ite_mux_network(network, argc, argv) network_t **network;
int argc;
char **argv;
{
  int c;
...
int com_act_bool_map_network(network, argc, argv) network_t **network;
int argc;
char **argv;
{
  int c;
...
void act_ite_alloc(node) node_t *node;
{
