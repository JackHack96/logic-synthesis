...
void xln_network_reduce_infeasibility_by_moving_fanins(network_t *network, int support, int MAX_FANINS) {
    array_t *nodevec;
    int     i;
    node_t  *node;
...
int xln_node_move_fanins(node_t *node, int support, int MAX_FANINS, int diff) {
    int     infeasibility;
    int     improvement;
    int     i, j, num_fanin;
    node_t  *fanin, *f;
...
-------------------------------------------------------------------*/
array_t *xln_get_bound_set(node_t *node, node_t *f, node_t *g, node_t *dup_node) {
    array_t *Y;
    int     j;
    node_t  *fanin;
