...
static char RCSid[] =
    "@(#)$Header: /users/pchong/CVS/sis/sis/linsolv/spAllocate.c,v 1.1.1.1 "
...
static void InitializeElementBlocks(Matrix, InitialNumberOfElements,
...
static void RecordAllocation(Matrix, AllocatedPtr)
...
static void AllocateBlockOfAllocationList(Matrix)
