...
static void CountMarkowitz(Matrix, RHS, Step)
...
static void MarkowitzProducts(Matrix, Step)
...
static RealNumber FindLargestInCol(pElement)
...
static RealNumber FindBiggestInColExclude(Matrix, pElement, Step)
...
static void ExchangeRowsAndCols(Matrix, pPivot, Step)
...
static void ExchangeColElements(Matrix, Row1, Element1, Row2, Element2, Column)
...
static void ExchangeRowElements(Matrix, Col1, Element1, Col2, Element2, Row)
...
static void RealRowColElimination(Matrix, pPivot)
...
static void ComplexRowColElimination(Matrix, pPivot)
...
static void UpdateMarkowitzNumbers(Matrix, pPivot)
