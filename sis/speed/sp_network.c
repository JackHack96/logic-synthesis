...
static int speed_delay_parameters_dup(from, to, speed_param,
                                      delay_flag) node_t *from,
    *to;
...
network_t *speed_network_create_from_node(f, speed_param, delay_flag) node_t *f;
speed_global_t *speed_param;
int delay_flag;
{
  network_t *network;
...
array_t *network_to_array(network) network_t *network;
{
 ...
 */
array_t *network_and_node_to_array(network, innode, table) network_t *network;
node_t *innode;
st_table *table;
{
  array_t *nodevec, *array;
