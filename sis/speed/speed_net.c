...
int speed_decomp_network(network_t *network, node_t *node, speed_global_t *speed_param, int attempt_no) {
    int                i, j;
    delay_time_t       time;
    node_t             *np, *temp, *best;
...
static int evaluate_kernel(node_t *kernel, node_t *cokernel, char *state) {
...
void node_evaluate(node_t *node, node_t *co_node, speed_global_t *speed_param, double *delay, double *area) {
    node_t       *fanin;
    delay_time_t atime;
...
static void speed_scale_value(divisor_t *div, divisor_data_t *best_data, speed_global_t *speed_param) {
