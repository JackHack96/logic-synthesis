...
int speed_decomp_network(network, node, speed_param,
                         attempt_no) network_t *network;
node_t *node;
...
static int evaluate_kernel(kernel, cokernel, state) node_t *kernel;
node_t *cokernel;
char *state;
{
...
void node_evaluate(node, co_node, speed_param, delay, area) node_t *node,
    *co_node;
speed_global_t *speed_param;
double *delay, *area;
{
...
static void speed_scale_value(div, best_data, speed_param) divisor_t *div;
