...
int buf_evaluate_trans2(network, buf_param, fanout_data, gate_array, a_array,
                        num_gates, cap_K_pos, cap_K_neg, req_diff,
...
static void buf_implement_trans2(network, buf_param, node, inv_node, fanouts,
                                 num_pos, num_neg, best_i, best_j, new_ap,
                                 new_bp, new_gIp) network_t *network;
buf_global_t *buf_param;
...
static void buf_annotate_trans2(network, buf_param, fanouts, num_pos, num_neg,
                                node, new_a, new_b, new_gI, best_g, best_gI,
                                best_a, best_b, best_i,
                                best_j) network_t *network;
buf_global_t *buf_param;
sp_fanout_t *fanouts;
int num_pos, num_neg;
