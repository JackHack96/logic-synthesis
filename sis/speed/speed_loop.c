...
void speed_loop_interface(network, thresh, coeff, dist, model,
...
void sp_dump_saved_network(sig, code, context) int sig, code;
...
void speed_up_loop(network, speed_param) network_t **network;
speed_global_t *speed_param;
{
  int i, status;
 ...
 */
void speed_up_script(network, speed_param) network_t **network;
speed_global_t *speed_param;
{
  if (speed_param->new_mode) {
