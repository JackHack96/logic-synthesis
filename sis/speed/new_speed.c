 ...
 */
/* ARGSUSED */
int new_speed(network, speed_param) network_t *network;
...
static int new_speed_recur(network, speed_param, level) network_t *network;
speed_global_t *speed_param;
int level;
{
  int i, j;
...
void sp_expand_selection(speed_param, mincut, clp_table,
                         select_table) speed_global_t *speed_param;
array_t *mincut;
 ...
 */
void speed_reorder_cutset(speed_param, clp_table,
                          mincut) speed_global_t *speed_param;
st_table *clp_table;
array_t **mincut;
{
  array_t *new_mincut;
 ...
 */
static void sp_compute_delta(network, speed_param, network_array,
                             current_pos) network_t *network;
speed_global_t *speed_param;
 ...
 */
static void sp_set_updated_constraints(rec, speed_param, network) sp_clp_t *rec;
speed_global_t *speed_param;
network_t *network;
{
  node_t *node, *orig;
 ...
 */
network_t *sp_get_network_to_collapse(f, speed_param, areap) node_t *f;
speed_global_t *speed_param;
 ...
 */
static void nsp_set_initial_load(orig_netw, net, speed_param,
                                 dup_nodes) network_t *orig_netw,
    *net;
speed_global_t *speed_param;
st_table *dup_nodes;
{
 ...
 */
static array_t *new_speed_collapse_bfs(f, speed_param, table) node_t *f;
speed_global_t *speed_param;
st_table *table;
{
  int i, j, k;
 ...
 */
static network_t *sp_generate_network_from_array(node_array, speed_param)
 ...
 */
static delay_time_t nsp_get_input_drive(node, model) node_t *node;
delay_model_t model;
{
  int i;
  delay_time_t drive;
 ...
 */
static void sp_do_initial_resynthesis(rec) sp_clp_t *rec;
{
  int tmp;
  node_t *np;
  delay_time_t new;
 ...
 */
static array_t *speed_filter_cutset(mincut, speed_param,
                                    weight_table) array_t *mincut;
speed_global_t *speed_param;
