...
static void do_speed_plot(network, plot_name, thresh, path_flag, cutset_flag,
                          print_gate_name, model, dist, coeff, fast_mode,
                          region_flag) network_t *network;
char *plot_name;
delay_model_t model;
...
int com__speed_plot(network, argc, argv) network_t **network;
int argc;
char **argv;
{
  int c;
