...
int speed_2c_decomp(network_t *network, node_t *node, speed_global_t *speed_param, int attempt_no) {
    int                 i, j;
    delay_time_t        time;
...
static int sp_eval_2c_kernel(ddivisor_t *ddivisor, node_t *node_2c, lsHandle **handlep, char *state) {
