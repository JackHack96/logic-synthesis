 ...
 */
void sp_print_delay_data(fp, network) FILE *fp;
network_t *network;
{
  lsGen gen;
  node_t *node;
 ...
 */
void new_speed_adjust_po_arrival(rec, model, arrival_p) sp_clp_t *rec;
delay_model_t model;
 ...
 */
delay_time_t nsp_compute_delay_saving(po, node, model) node_t *po, *node;
delay_model_t model;
{
...
void sp_print_network(network, comment) network_t *network;
char *comment;
{
  int i;
  lsGen gen;
 ...
 */
static void sp_adjust_input_arrival(rec, network) sp_clp_t *rec;
network_t *network;
{
  int i;
  double load;
 ...
 */
sp_clp_t *sp_create_collapse_record(node, wght, speed_param,
                                    ti_model) node_t *node;
sp_weight_t *wght;
...
void nsp_free_collapse_record(rec) sp_clp_t *rec;
{
  node_t *node;
  delay_time_t *tp;
  st_generator *stgen;
 ...
 */
int new_speed_is_fanout_po(node) node_t *node;
{
  lsGen gen;
  node_t *fo;
 ...
 */
st_table *speed_store_required_times(network) network_t *network;
{
  lsGen gen;
  node_t *po;
  st_table *table;
 ...
 */
void speed_restore_required_times(table) st_table *table;
{
  node_t *po;
  char *dummy;
  st_generator *stgen;
 ...
 */
void sp_patch_fanouts_of_node(node, new_fanin) node_t *node, *new_fanin;
{
  int j = 0;
  lsGen gen;
 ...
 */
array_t *sp_get_local_trans(n_entries, entries) int n_entries;
char **entries;
{
  int i, j, num;
  sp_xform_t *ti_model;
 ...
 */
void sp_free_local_trans(p_array_of_methods) array_t **p_array_of_methods;
{
  int i;
  sp_xform_t *ti_model;
 ...
 */
void sp_print_local_trans(array_of_methods) array_t *array_of_methods;
{
  int i;
  sp_xform_t *ti_model;
 ...
 */
int sp_num_active_local_trans(speed_param) speed_global_t *speed_param;
{
  int i, n;
 ...
 */
int sp_num_local_trans_of_type(speed_param, type) speed_global_t *speed_param;
 ...
 */
sp_xform_t *sp_local_trans_from_index(speed_param,
                                      n) speed_global_t *speed_param;
int n;
{
  array_t *array_of_methods = speed_param->local_trans;
  sp_xform_t *ti_model;
...
void nsp_get_orig_edge(network, name, fo,
                       index) network_t *network; /* The original network */
...
node_t *nsp_network_find_node(network, name) network_t *network;
char *name;
{
  char *pos;
  node_t *node;
 ...
 */
void sp_delete_network(speed_param, network, node, delete_network, select_table,
...
node_t *nsp_find_equiv_node(network, equiv_name_table, name) network_t *network;
 ...
 */
void sp_append_network(speed_param, network, append_network, ti_model,
                       equiv_name_table, roots) speed_global_t *speed_param;
network_t *network;
...
/* ARGSUSED */
static node_t *sp_find_substitute(network, node, model) network_t *network;
node_t *node;
delay_model_t model;
{
  int nin;
 ...
 * collapsing.
 */
void new_free_weight_info(clp_table) st_table *clp_table;
{
  node_t *np;
  st_generator *stgen;
  sp_weight_t *wght;
 ...
 */
double nsp_get_load_limit(node, fanin_index, speed_param) node_t *node;
int fanin_index;
speed_global_t *speed_param;
{
  lsGen gen;
 ...
 */
network_t *nsp_get_dual_network(node, speed_param) node_t *node;
speed_global_t *speed_param;
{
...
network_t *buf_get_fanout_network(node, speed_param) node_t *node;
speed_global_t *speed_param;
{
  char *name;
  int i, pin;
 ...
 */
int nsp_fanout_compare(p1, p2) char *p1, *p2;
{
...
delay_time_t nsp_min_req_time(network, model) network_t *network;
delay_model_t model;
{
  lsGen gen;
  node_t *pi;
 ...
 */
static void nsp_split_fanouts(network, speed_param) network_t *network;
speed_global_t *speed_param;
{
  lsGen gen;
  int i, best_index;
 ...
 */
/* ARGSUSED */
network_t *sp_noalg_opt(network, ti_model, speed_param) network_t *network;
sp_xform_t *ti_model;
speed_global_t *speed_param;
{
...
/* ARGSUSED */
network_t *sp_divisor_opt(network, ti_model, speed_param) network_t *network;
sp_xform_t *ti_model;
speed_global_t *speed_param;
{
...
/* ARGSUSED */
network_t *sp_2c_kernel_opt(network, ti_model, speed_param) network_t *network;
sp_xform_t *ti_model;
speed_global_t *speed_param;
{
  node_t *clp_node, *temp;
...
/* ARGSUSED */
network_t *sp_comp_div_opt(network, ti_model, speed_param) network_t *network;
sp_xform_t *ti_model;
speed_global_t *speed_param;
{
  node_t *clp_node, *temp;
...
/* ARGSUSED */
network_t *sp_comp_2c_opt(network, ti_model, speed_param) network_t *network;
sp_xform_t *ti_model;
speed_global_t *speed_param;
{
  node_t *clp_node, *temp;
 ...
 */
/* ARGSUSED */
network_t *sp_and_or_opt(network, ti_model, speed_param) network_t *network;
sp_xform_t *ti_model;
speed_global_t *speed_param;
{
  node_t *clp_node;
...
static void sp_map_if_required(network, speed_param) network_t **network;
speed_global_t *speed_param;
{
  network_t *map_net;
...
buf_global_t *nsp_init_buf_param(network, model) network_t *network;
delay_model_t model;
{
 ...
 */
int nsp_downsize_non_crit_gates(network, model) network_t *network;
delay_model_t model;
{
  int success;
...
/* ARGSUSED */
network_t *sp_fanout_opt(network, ti_model, speed_param) network_t *network;
sp_xform_t *ti_model;
speed_global_t *speed_param;
{
  network_t *opt_network;
 ...
 */
/* ARGSUSED */
network_t *sp_duplicate_opt(network, ti_model, speed_param) network_t *network;
sp_xform_t *ti_model;
speed_global_t *speed_param;
{
  network_t *opt_network;
 ...
 */
/* ARGSUSED */
network_t *sp_dual_opt(network, ti_model, speed_param) network_t *network;
sp_xform_t *ti_model;
speed_global_t *speed_param;
{
  network_t *opt_network;
 ...
 */
/* ARGSUSED */
network_t *sp_cofactor_opt(network, ti_model, speed_param) network_t *network;
sp_xform_t *ti_model;
speed_global_t *speed_param;
{
...
/* ARGSUSED */
network_t *sp_bypass_opt(network, ti_model, speed_param) network_t *network;
sp_xform_t *ti_model;
speed_global_t *speed_param;
{
  network_t *new_net;
 ...
 */
/* ARGSUSED */
delay_time_t new_delay_arrival(node, speed_param) node_t *node;
speed_global_t *speed_param;
{
 ...
 */
/* ARGSUSED */
delay_time_t new_delay_required(node, speed_param) node_t *node;
speed_global_t *speed_param;
{
  delay_time_t req;
 ...
 */
/* ARGSUSED */
delay_time_t new_delay_slack(node, speed_param) node_t *node;
speed_global_t *speed_param;
{
  delay_time_t req;
...
network_t *speed_network_dup(old) network_t *old;
{
  network_t *new;
...
static node_t *speed_node_dup(old) register node_t *old;
{
  register node_t *new;
