...
{
if (current_speedup_alg ==
NIL(array_t)
){
current_speedup_alg = sp_get_local_trans(0, NIL(
char *));
}
speed_param->
local_trans = current_speedup_alg;
speed_param->
area_reclaim = TRUE;
speed_param->
trace = FALSE;
...
add_inv = FALSE;
speed_param->
del_crit_cubes = TRUE;      /* Reduce delay at all cost */
speed_param->
num_tries = 1;
speed_param->
...
speed_param->
new_mode = 1;                /* Use the new_speed code */
speed_param->
region_flag = ALONG_CRIT_PATH;
speed_param->
transform_flag = BEST_BENEFIT;
speed_param->
max_recur = 1;
speed_param->
timeout = INFINITY;
...
limit = 2;
buf_param->
mode = 7;             /* Try all the transformations */
buf_param->
thresh = 2 * V_SMALL;
buf_param->
