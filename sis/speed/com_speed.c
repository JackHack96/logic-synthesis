 ...
 */
speed_set_default_options(speed_param) speed_global_t *speed_param;
{
...
int speed_fill_options(speed_param, argc, argv) speed_global_t *speed_param;
int argc;
char **argv;
{
  int c;
 ...
 * of Boolean networks.
 */
int com_speed_up(network, argc, argv) network_t **network;
int argc;
char **argv;
{
  int i;
 ...
 */
int com__part_collapse(network, argc, argv) network_t **network;
int argc;
char **argv;
{
  int i;
 ...
 */
int com__print_cutset(network, argc, argv) network_t **network;
int argc;
char **argv;
{
  array_t *mincut;
 ...
 */
int com__print_weight(network, argc, argv) network_t **network;
int argc;
char **argv;
{
  st_table *table;
...
int com__speed_delay(network, argc, argv) network_t **network;
int argc;
char **argv;
{
...
int com__report_delay_data(network, argc, argv) network_t **network;
int argc;
char **argv;
{
  int c;
...
static int com_speedup_alg(network, argc, argv) network_t **network;
int argc;
char **argv;
{
  int no_options = 0;
...
int com_print_level(network, argc, argv) network_t **network;
int argc;
char **argv;
{
  double thresh;
...
int com__is_2ip_and(network, argc, argv) network_t **network;
int argc;
char **argv;
{
  node_t *node;
 ...
 * critical paths
 */
int com__print_fanout(network, argc, argv) network_t **network;
int argc;
char **argv;
{
 ...
 */
buf_set_default_options(buf_param) buf_global_t *buf_param;
{
...
int buffer_fill_options(buf_param, argc, argv) buf_global_t *buf_param;
int argc;
char **argv;
{
  int c;
...
int com_buffer_opt(network, argc, argv) network_t **network;
int argc;
char **argv;
{
  lsGen gen;
...
end_speed() { sp_free_local_trans(&current_speedup_alg); }
