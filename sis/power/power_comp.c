 ...
 */
double power_calc_func_prob(f_bdd, infoPIs) bdd_t *f_bdd;
power_pi_t *infoPIs;
{
  double result;
  char *value, *key;
 ...
 */
static double power_count_prob(f) bdd_t *f;
{
  bdd_t *child;
 ...
 */
static double power_count_prob_w_stateProb(f, stateProb, stateIndex,
                                           encoding) bdd_t *f;
double *stateProb;
st_table *stateIndex;
char *encoding;
...
static void evaluate_included_state_prob(encoding, stateProb, stateIndexTable,
                                         lineIndex, result) char *encoding;
double *stateProb;
 ...
 *  of PS lines
 */
double power_calc_func_prob_w_sets(f_bdd, infoPIs, psProb,
 ...
 *  in the previous set.
 */
static double power_count_f_prob_w_sets(f, psProb, nPSLines, prevInd,
                                        sets) bdd_t *f;
double *psProb;
int nPSLines;
long prevInd;
...
static void multiply_PS_prob(result, index, psProb, sets) double *result;
long index;
double *psProb;
pset sets;
{
