...
int power_sample_estimate(network, type, delay, num_samples,
...
static double power_sample_do_estimate(network, num_iter, num_gap,
                                       probPI) network_t *network;
...
static double calculate_power(network, n_ones, i) network_t *network;
int *n_ones;
int i;
{
  node_t *po;
...
static double *power_get_PIs_prob(symbolic, info_table) network_t *symbolic;
st_table *info_table;
{
  node_t *pi;
  node_info_t *info;
...
static void gen_random_pattern(n, pattern, seed, probPI) int n;
long *pattern;
int seed;
double *probPI;
{
...
static void simulate_network_word(network, pi_values,
                                  po_values) network_t *network;
long *pi_values;
long *po_values;
{
...
static long simulate_network_word_rec(network, table, node) network_t *network;
st_table *table;
node_t *node;
{
  node_t *input;
...
static long simulate_node_word(node, inputs) node_t *node;
long **inputs;
{
  register int i, j;
  node_t *fanin;
