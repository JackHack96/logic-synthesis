        ...
        double *total_power;
{
    ...
    switch (type) {
        ...
        case SEQUENTIAL:       /* For sampling, only PSlines probability */
          ...
          break;
#endif /* SIS */
        case DYNAMIC:fprintf(siserr, "Error! Sorry, this version does not support dynamic circuits in sample mode.\n");
            return 1;
        default:fprintf(siserr, "Internal error!!! Unknown type in power_simulation_estimate!\n");
            return 1;
    }
        ...
        st_table *info_table;
{
    ...
    probPI = ALLOC(
    double, network_num_pi(symbolic));
