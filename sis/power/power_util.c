...
int power_print_info(network) network_t *network;
{
  node_t *node;
  power_info_t *info;
...
array_t *power_network_dfs(net) network_t *net;
{
...
void power_network_print(net) network_t *net;
{
  array_t *node_vec;
  node_t *node;
  int i;
...
pset power_lines_in_set(set, setSize) pset set;
int setSize;
{
