...
int power_pipe_arbit(network, info_table, total_power) network_t *network;
st_table *info_table;
double *total_power;
{
...
int power_add_pipeline_logic(network, symbolic) network_t *network;
network_t *symbolic;
{
...
static void power_pipe_network_concatenate(symbolic, zero_delay_net,
                                           instant) network_t *symbolic;
network_t *zero_delay_net;
char *instant;
{
