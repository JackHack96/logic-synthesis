...
void factor_print(fp, f) FILE *fp;
node_t *f;
{
  int length = 0;
...
static void ft_tree_print(fp, node, f, len) FILE *fp;
node_t *node;
ft_t *f;
int *len;
{
...
static void ft_leaf_print(fp, node, f, len) FILE *fp;
node_t *node;
ft_t *f;
int *len;
{
...
static void ft_inv_print(fp, node, f, len) FILE *fp;
node_t *node;
ft_t *f;
int *len;
{
...
static void ft_or_print(fp, node, f, len) FILE *fp;
node_t *node;
ft_t *f;
int *len;
{
...
static void ft_and_print(fp, node, f, len) FILE *fp;
node_t *node;
ft_t *f;
int *len;
{
...
void ft_print(r, f, level) node_t *r;
ft_t *f;
int level;
{
  ft_t *p;
...
static char *ft_name(r, f) node_t *r;
ft_t *f;
{
  char *name;
 ...
 */
/* ARGSUSED */
void ft_len_init(r, f) node_t *r;
ft_t *f;
{ factor_traverse(r, ft_len, NIL(char), FACTOR_TRAV_POST_ORDER); }

/* ARGSUSED */
static int ft_len(r, f, stat) node_t *r;
ft_t *f;
char *stat;
{
  ft_t *p;
