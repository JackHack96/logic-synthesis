...
int com_factor(network_t **network, int argc, char **argv) {
    int     c, method;
    array_t *nodevec;
    node_t  *np;
    int     i;
...
int com_pf(network_t **network, int argc, char **argv) {
    array_t *nodevec;
    int     i, n;
    node_t  *np, *fanin;
...
int com_pv(network_t **network, int argc, char **argv) {
    array_t *nodevec;
    int     i, j, n, num;
    int     order, c;
    node_t  *np;
...
int com_pft(network_t **network, int argc, char **argv) {
    array_t *nodevec;
    int     i, n;
    node_t  *np;
...
static char *my_node_long_name(node_t *node) {
...
int com_factor_conv(network_t **network, int argc, char **argv) {
    array_t *nodevec, *fa;
    int     i, j, k;
    node_t  *f, *np, *fanin;
...
int com_eliminate(network_t **network, int argc, char **argv) {
    int limit, value;
...
static int el_valid_val(char *s) {
    int i, first;
...
static node_t *first_fanin(node_t *np) {
    node_t *fanin, *first;
    int    i;
