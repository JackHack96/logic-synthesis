 ...
 */
void factor_recur(node_t *f, node_t *(*gen_factor)()) {
    node_t *k, *ck;
...
static void factor_special(node_t *f, node_t *ck, node_t *(*gen_factor)()) {
...
static void factor_general(node_t *f, node_t *ck, node_t *(*gen_factor)()) {
    node_t *c1, *p, *q1, *c2, *q;
