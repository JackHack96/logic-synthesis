...
int factor_num_used(node_t *o, node_t *i) {
    stat_t s;
...
/* ARGSUSED */
static int factor_count(node_t *r, ft_t *f, char *stat) {
    stat_t *s;
...
int factor_num_literal(node_t *f) {
    int sum = 0;
...
/* ARGSUSED */
static int literal_sum(node_t *r, ft_t *np, char *sum) {
    int *s;
...
void value_print(FILE *fp, node_t *np) {
    int value;
...
int value_cmp_inc(char **p1, char **p2) { return node_value((node_t *) *p1) - node_value((node_t *) *p2); }

int value_cmp_dec(char **p1, char **p2) { return node_value((node_t *) *p2) - node_value((node_t *) *p1); }
