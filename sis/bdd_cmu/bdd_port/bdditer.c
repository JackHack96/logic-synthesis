 ...
 */
boolean bdd_next_cube(bdd_gen *gen, array_t **cube) {
 ...
 *
 */
static void push_cube_stack(bdd_node *f, bdd_gen *gen) {
...
static void pop_cube_stack(bdd_gen *gen) {
 ...
 *    Return nothing, just do it.
 */
static void push_node_stack(bdd_node *f, bdd_gen *gen) {
    bdd_node            *f0, *f1;
...
static void pop_node_stack(bdd_gen *gen) {
    bdd_node *branch_f;
 ...
 */
static void bdd_get_branches(bdd_node *f, bdd_node **f_T, bdd_node **f_E) {
    BDD_SETUP(f);
