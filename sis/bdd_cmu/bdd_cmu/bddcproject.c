...
static bdd
#if defined(__STDC__)
cmu_bdd_smooth_g_step(cmu_bdd_manager bddm, bdd f, long op, var_assoc vars,
                      long id)
#else
    cmu_bdd_smooth_g_step(bddm, f, op, vars, id) cmu_bdd_manager bddm;
bdd f;
long op;
var_assoc vars;
long id;
...
#else
    cmu_bdd_smooth_g(bddm, f, id) cmu_bdd_manager bddm;
bdd f;
long id;
#endif
{
...
#else
    cmu_bdd_project_step(bddm, f, op, vars) cmu_bdd_manager bddm;
bdd f;
long op;
var_assoc vars;
#endif
...
#else
    cmu_bdd_project(bddm, f) cmu_bdd_manager bddm;
bdd f;
#endif
{
  long op;
