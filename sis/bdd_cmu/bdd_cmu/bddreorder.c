...
#endif
{
    ...
    switch (best) {
        case 0:bdd_exchange_var_blocks(bddm, b, i + 1);
            break;
        case 1:bdd_exchange_var_blocks(bddm, b, i + 1);
            bdd_exchange_var_blocks(bddm, b, i);
            break;
        case 2:bdd_exchange_var_blocks(bddm, b, i + 1);
            bdd_exchange_var_blocks(bddm, b, i);
            bdd_exchange_var_blocks(bddm, b, i + 1);
            break;
        case 3:bdd_exchange_var_blocks(bddm, b, i);
            bdd_exchange_var_blocks(bddm, b, i + 1);
            break;
        case 4:bdd_exchange_var_blocks(bddm, b, i);
            break;
        case 5:break;
    }
    return (best > 0);
...
#endif
{
    ...
    if (reorder_fn == cmu_bdd_reorder_hybrid) {
        bddm->reorder_data = mem_get_block((SIZE_T)
        sizeof(double));
