...
#else
    cmu_bdd_exists_step(bddm, f, op, vars) cmu_bdd_manager bddm;
bdd f;
long op;
var_assoc vars;
#endif
...
#else
    cmu_bdd_exists_temp(bddm, f, op) cmu_bdd_manager bddm;
bdd f;
long op;
#endif
{
...
#else
    cmu_bdd_exists(bddm, f) cmu_bdd_manager bddm;
bdd f;
#endif
{
  long op;
...
#else
    cmu_bdd_forall(bddm, f) cmu_bdd_manager bddm;
bdd f;
#endif
{
  bdd temp;
