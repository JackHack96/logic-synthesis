...
#else
    cmu_bdd_reduce_step(bddm, f, c) cmu_bdd_manager bddm;
bdd f;
bdd c;
#endif
{
...
#else
    cmu_bdd_reduce(bddm, f, c) cmu_bdd_manager bddm;
bdd f;
bdd c;
#endif
{
...
#else
    cmu_bdd_cofactor_step(bddm, f, c) cmu_bdd_manager bddm;
bdd f;
bdd c;
#endif
{
...
#else
    cmu_bdd_cofactor(bddm, f, c) cmu_bdd_manager bddm;
bdd f;
bdd c;
#endif
{
