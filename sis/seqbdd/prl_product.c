...
void Prl_ProductBddOrder(seq_info_t *seq_info, prl_options_t *options) {
...
static void compute_po_ordering(seq_info_t *seq_info, prl_options_t *options) {
    int        i, index;
    lsGen      gen;
    node_t     *output;
...
static void compute_pi_ordering(seq_info_t *seq_info, prl_options_t *options) {
    char         buffer[10];
    char         *value;
    int          i, index;
    int          n_vars;
...
static void add_new_inputs(seq_info_t *seq_info, array_t *node_list) {
    int    i;
    int    index;
    node_t *input;
    bdd_t  *var;
...
static void add_next_state_vars(seq_info_t *seq_info, st_table *next_state_table) {
    int       i;
    int       index;
    bdd_t     *var;
    node_t    *input;
...
static array_t *
order_dfs_from_count(node_t *node, st_table *leaves, int fixed_root_order, int *order_count, int verbosity) {
    st_generator *gen;
    char         *key;
    char         *value;
    int          i, index;
...
static void ResetVariableOrder(st_table *leaves, node_t *node) {
    int index;
...
static void SetVariableOrder(st_table *leaves, node_t *node, int varid, int verbosity) {
    int index;
...
void Prl_ProductInitSeqInfo(seq_info_t *seq_info, prl_options_t *options) {
    int     i;
    bdd_t   *fn;
    bdd_t   *var;
    int     n_elts;
...
void Prl_ProductFreeSeqInfo(seq_info_t *seq_info, prl_options_t *options) {
...
array_t *Prl_ProductExtractNetworkInputNames(seq_info_t *seq_info, prl_options_t *options) {
    int     i;
    array_t *result;
    char    *name;
...
bdd_t *Prl_ProductComputeNextStates(bdd_t *current_set, seq_info_t *seq_info, prl_options_t *options) {
...
bdd_t *Prl_ProductReverseImage(bdd_t *next_set, seq_info_t *seq_info, prl_options_t *options) {
...
static bdd_t *BddIncrAndSmooth(seq_info_t *seq_info, bdd_t *current_set, array_t *keep_vars, prl_options_t *options) {
    int            i;
    int            n_fns;
    bdd_t          *tmp;
    bdd_t          **fns;
...
static support_info_t *
support_info_extract(seq_info_t *seq_info, bdd_t **fns, int n_fns, array_t *keep_vars, prl_options_t *options) {
    int            i;
...
/* ARGSUSED */
static void extract_fn_info(support_info_t *support_info, bdd_t **fns, prl_options_t *options) {
    int       i;
    fn_info_t *info;
...
static void
initialize_partition_info(support_info_t *support_info) {
    int      n_partitions;
    int      partition;
    int      i, n, x;
    int      count;
...
static void smooth_lonely_variables(support_info_t *support_info, prl_options_t *options) {
    int     varid;
    int     index;
    bdd_t   *tmp;
    int     remaining;
...
static bdd_t *do_fn_merging(support_info_t *support_info, prl_options_t *options) {
    int       i;
    bdd_t     *tmp;
    fn_info_t *fn0, *fn1;
    array_t   *smooth_vars;
...
static var_info_t *var_info_free(var_info_t *info) {
    bdd_free(info->var);
