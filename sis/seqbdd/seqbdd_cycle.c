...
int seqbdd_extract_input_sequence(network_t *network, int n_shift, st_table *input_order, array_t *input_seq,
...
static void store_ancestor_state_info(network_t *network, range_data_t *seq_info, st_table *reset_ancestor_table,
                                      bdd_t *ancestor_state) {
    lsGen   gen;
    node_t  *pi;
    latch_t *latch;
...
static char *convert_input_minterm_to_char_string(network_t *network, range_data_t *seq_info, st_table *input_order,
                                                  bdd_t *input_minterm) {
    st_generator *stgen;
    node_t       *pi;
    bdd_t        *var, *bdd_var;
...
static void
seqbdd_get_one_edge(bdd_t *from, range_data_t *seq_info, array_t *ps_array, array_t *pi_array, bdd_t **state,
                    bdd_t **input) {
    bdd_t    *minterm;
    st_table *var_table;
