...
static int  do_find_best_set_order 	  (set_info_t *, set_key_t *, st_table *, int, int);
static void extract_best_order_from_cache (set_info_t *, st_table *, set_key_t *, array_t *);
...
static int 	  arg_min_remaining_size      (set_info_t *, var_set_t *, var_set_t *, int *);
