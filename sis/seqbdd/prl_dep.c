...
int Prl_RemoveDependencies(network, nodevec, options) network_t *network;
array_t *nodevec;
...
static int CheckInput(network, nodevec) network_t *network;
array_t *nodevec;
{
  int i;
  node_t *pi, *po;
...
static array_t *ExtractPiTfo(network, pi) network_t *network;
node_t *pi;
{
  int i, j;
  node_t *node, *fanin;
...
static void BlowAwayDependencies(nodes, roots) array_t *nodes;
st_table *roots;
{
  int i;
  int all_roots;
...
static array_t *GetRootFanouts(node, roots) node_t *node;
st_table *roots;
{
  lsGen gen;
  node_t *fanout;
...
static node_t *ProcessInternalNode(node, root_fanouts) node_t *node;
array_t *root_fanouts;
{
  node_t *copy;
...
static void ProcessPrimaryInput(node, root_fanouts) node_t *node;
array_t *root_fanouts;
{
  node_t *copy;
...
static void PatchFanin(nodevec, old, new) array_t *nodevec;
node_t *old;
node_t *new;
{
  int i;
