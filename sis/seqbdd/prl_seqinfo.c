...
seq_info_t *Prl_SeqInitNetwork(network_t *network, prl_options_t *options) {
...
static void seq_build_output_bdds(seq_info_t *seq_info) {
    int    i;
    bdd_t  *fn;
    node_t *output;
...
static void seq_build_dc_bdds(seq_info_t *seq_info) {
    int       i;
    lsGen     gen;
    char      *output_name;
    node_t    *input;
...
static void seq_register_pis_as_bdd_inputs(seq_info_t *seq_info, network_t *dc_network) {
    int    var_index;
    lsGen  gen;
    node_t *dc_input;
    node_t *input;
...
static void seq_compute_init_state(seq_info_t *seq_info) {
    lsGen     gen;
    latch_t   *latch;
    node_t    *pi;
    int       var_index;
...
void Prl_SeqInfoFree(seq_info_t *seq_info, prl_options_t *options) {
    int  i;
    char *name;
...
bdd_t *Prl_ExtractReachableStates(seq_info_t *seq_info, prl_options_t *options) {
