...
range_data_t *bull_alloc_range_data(network_t *network, verif_options_t *options) {
    bdd_t         *bdd;
    array_t       *pi_list;
    array_t       *po_ordering;
    node_t        *n1, *n2;
...
void bull_free_range_data(range_data_t *data, verif_options_t *options) {
    output_info_t *info = options->output_info;
...
bdd_t *bull_compute_next_states(bdd_t *current_set, range_data_t *data, verif_options_t *options) {
    int           i;
    array_t       *bdd_list;
    node_t        *n1;
    bdd_t         *f1, *fc;
...
bdd_t *bull_compute_reverse_image(bdd_t *next_set, range_data_t *data, verif_options_t *options) { return NIL(bdd_t); }

/* returns 1 iff everything is OK */
int bull_check_output(bdd_t *current_set, range_data_t *data, int *output_index, verif_options_t *options) {
    int   i;
    bdd_t *bdd;
...
void bull_bdd_sizes(range_data_t *data, int *fn_size, int *output_size) {
    int    i;
    bdd_t  *fn;
    node_t *node;
    bdd_t  *output;
...
bdd_t *
bull_cofactor(array_t *bdd_list, array_t *pi_list, bdd_manager *mg, bdd_t *total_set, st_table *cache, st_table *leaves,
...
static bdd_t *
bull_cache_lookup(st_table *cache, array_t *bdd_list, array_t *pi_list, bdd_manager *manager, st_table *leaves) {
    int          i;
    bull_key_t   key;
    bull_value_t *value;
...
static void bull_cache_free(st_table *cache) {
    int          i;
    bdd_t        *f;
    st_generator *gen;
    bull_key_t   *key;
...
static int bull_key_cmp(char *obj1, char *obj2) {
    int     i;
    bdd_t   *f1, *f2, *inv;
...
static int bull_key_hash(char *obj, int modulus) {
    int                   i;
    bdd_t                 *fn;
