...
/* ARGSUSED */
range_data_t *product_alloc_range_data(network, options) network_t *network;
...
void product_free_range_data(data, options) range_data_t *data;
verif_options_t *options;
{
  int i;
  node_t *node;
...
bdd_t *product_compute_next_states(current_set, data,
...
bdd_t *product_compute_reverse_image(next_set, data, options) bdd_t *next_set;
range_data_t *data;
verif_options_t *options;
{
  int i;
...
bdd_t *bdd_incr_and_smooth(transition_outputs, current_set, keep_vars,
                           options) array_t *transition_outputs;
bdd_t *current_set;
array_t *keep_vars;
verif_options_t *options;
{
...
int product_check_output(current_set, data, output_index,
                         options) bdd_t *current_set;
range_data_t *data;
int *output_index;
verif_options_t *options;
...
void product_bdd_sizes(data, fn_size, output_size) range_data_t *data;
int *fn_size;
int *output_size;
{
  int i;
...
static support_info_t *support_info_extract(keep_vars, n_fns, fns,
                                            options) array_t *keep_vars;
int n_fns;
bdd_t **fns;
verif_options_t *options;
{
...
static void *var_info_free(info) var_info_t *info;
{
  bdd_free(info->var);
