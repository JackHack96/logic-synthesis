...
void Prl_EquivNets(network, options) network_t *network;
...
static void equiv_nets(network, seq_info, dc, options) network_t *network;
seq_info_t *seq_info;
bdd_t *dc;
prl_options_t *options;
{
...
static int skip_this_net(net_info) net_info_t *net_info;
{
...
static void initialize_net_entry(seq_info, net_info, node, index,
                                 care_set) seq_info_t *seq_info;
net_info_t *net_info;
node_t *node;
int index;
bdd_t *care_set;
...
static void compute_equivalence_classes(n_nets, net_info) int n_nets;
net_info_t *net_info;
{
  int i, j;
...
static void report_equivalence_classes(n_nets, net_info) int n_nets;
net_info_t *net_info;
{
  int i;
  int max_size;
...
static void collapse_equiv_nets(net_info, options) net_info_t *net_info;
prl_options_t *options;
{
  int i;
  int is_inverted;
...
static void compute_node_cost_rec(node, cost_table, depth_table) node_t *node;
st_table *cost_table;
...
static void MoveFanout(from, to) node_t *from;
node_t *to;
{
  int i;
  lsGen gen;
