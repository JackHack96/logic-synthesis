...
int Prl_ExtractEnvDc(fsm_network, env_network, options) network_t *fsm_network;
...
static int AddEnvFsm(to_network, env_network,
                     connections) network_t *to_network;
network_t *env_network;
...
static int CopyRealPo(network, node, name) network_t *network;
node_t *node;
char *name;
{
...
static void CopyLatchPo(network, node, name, original_po) network_t *network;
node_t *node;
char *name;
node_t *original_po;
{
...
static node_t *AddPrimaryOutput(network, fanin, name) network_t *network;
node_t *fanin;
char *name;
{
  node_t *result;
...
static void ExtractBddVars(seq_info, env_network, env_vars,
                           fsm_state_vars) seq_info_t *seq_info;
network_t *env_network;
array_t *env_vars;
array_t *fsm_state_vars;
{
...
static bdd_t *MakeFsmInputRelation(seq_info,
                                   controlled_fsm_inputs) seq_info_t *seq_info;
array_t *controlled_fsm_inputs;
{
  int i;
  bdd_t *result;
...
int Prl_VerifyEnvFsm(fsm_network, check_network, env_network,
                     options) network_t *fsm_network;
...
static int BreadthFirstTraversal(seq_info, options, checkFn,
                                 closure) seq_info_t *seq_info;
prl_options_t *options;
CheckFn checkFn;
void *closure;
{
...
static int CheckCurrentStateTautology(current_set, total_set, seq_info, options,
                                      closure) bdd_t *current_set;
bdd_t *total_set;
seq_info_t *seq_info;
prl_options_t *options;
void *closure;
...
static void ReportEnvErrorTrace(product_network, connections, seq_info,
                                options) network_t *product_network;
array_t *connections;
seq_info_t *seq_info;
prl_options_t *options;
{
...
static int CheckAndRecordStates(current_set, total_set, seq_info, options,
                                closure) bdd_t *current_set;
bdd_t *total_set;
seq_info_t *seq_info;
prl_options_t *options;
...
static void PrintEnvErrorTrace(input_trace, product_network, connections,
                               seq_info, options) array_t *input_trace;
network_t *product_network;
array_t *connections;
seq_info_t *seq_info;
prl_options_t *options;
...
static PrintClosure *PrintClosureInit(product_network, connections,
                                      seq_info) network_t *product_network;
array_t *connections;
seq_info_t *seq_info;
{
  lsGen gen;
...
static array_t *ExtractFsmInputs(network, connections) network_t *network;
array_t *connections;
{
  int i;
  lsGen gen;
...
static array_t *PrintClosureSimulateNetwork(input, closure) bdd_t *input;
PrintClosure *closure;
{
  int i;
  int value;
...
static void PrintClosureFree(closure) PrintClosure *closure;
{
...
static int MakeProductFsm(to_network, from_network, xnor_outputs,
                          other_outputs) network_t *to_network;
...
static node_t *AddXnorPo(network, po, node) network_t *network;
node_t *po;
node_t *node;
{
  char *name;
...
static void RemoveUnusedPos(network, used_outputs, options) network_t *network;
...
static void FreeConnectionArray(connections) array_t *connections;
{
  int i;
  Connection connection;
