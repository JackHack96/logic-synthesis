...
int com_execute(network_t **network, char *command) {
    int  status, argc;
    int  loop;
    char *commandp, **argv;
...
static int com_dispatch(network_t **network, int argc, char **argv) {
    int             status;
    char            *value;
 ...
 */
static int apply_alias(network_t **network, int *argcp, char ***argvp, int *loop) {
