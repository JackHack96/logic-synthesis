...
array_t *com_get_true_nodes(network_t *network, int argc, char **argv) {
    array_t *node_list;
    int     i, j;
    char    *arg;
    node_t  *node, *p;
...
array_t *com_get_true_io_nodes(network_t *network, int argc, char **argv) {
    array_t *node_list;
    int     i, j;
    char    *arg;
    node_t  *node, *p;
...
static char *get_arg(char *strng) {
    char *paren, *arg;
...
static node_t *get_true_node_by_name(network_t *network, char *name) {
    int    found;
    char   *dummy;
    node_t *node;
