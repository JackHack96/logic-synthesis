...
array_t *com_get_true_nodes(network, argc, argv) network_t *network;
int argc;
char **argv;
{
  array_t *node_list;
...
array_t *com_get_true_io_nodes(network, argc, argv) network_t *network;
int argc;
char **argv;
{
  array_t *node_list;
...
static node_t *get_true_node_by_name(network, name) network_t *network;
char *name;
{
  int found;
  char *dummy;
