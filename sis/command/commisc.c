...
(void)
fprintf(siserr,
"usage: usage -- give CPU usage statistics\n");
return 1;
}
...
/* ARGSUSED */
static int
com_infinite_loop(network, argc, argv)
        network_t **network;
        int argc;
        char **argv;
{
