...
void virtual_delay_compute_arrival_times(network_t *network, bin_global_t globals) {
    lsGen    gen;
    node_t   *pi, *po;
...
static void update_gate_link_loads_rec(st_table *table, node_t *node) {
    int         i;
    node_t      *input;
    gate_link_t link;
...
void virtual_delay_arrival_times_rec(st_table *table, node_t *node) {
    int pin;
...
static void virtual_delay_compute_node_arrival_time(node_t *node) {
    int          i;
    node_t       *input;
