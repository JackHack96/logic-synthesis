...
static int match(register node_t *net_node, register prim_edge_t *list) {
    register int         i, cont;
...
void
gen_all_matches(node_t *node, prim_t *prim, int (*func)(), int debug, int allow_internal_fanout, int fanout_limit) {
    g_func                  = func;
    g_prim                  = prim;
    g_debug                 = debug;
