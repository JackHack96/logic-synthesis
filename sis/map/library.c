...
int lib_read_blif(fp, filename, add_inverter, nand_flag, library_p) FILE *fp;
char *filename;
int add_inverter;
int nand_flag;
library_t **library_p;
...
static int process_pattern(library, network) library_t *library;
network_t *network;
{
  lib_class_t *class;
  lib_gate_t *gate;
...
static int process_constant(library, network) library_t *library;
network_t *network;
{
  node_t *node;
...
static int found_match(prim) prim_t *prim;
{
  int i;
...
int lib_pattern_matches(network, prim, ignore_type) network_t *network;
prim_t *prim;
int ignore_type;
{
  node_t *po;
...
static prim_t *find_or_create_pattern(library, network) library_t *library;
network_t *network;
{
  lsGen gen;
  prim_t *prim;
...
static lib_gate_t *find_gate(library, network) library_t *library;
network_t *network;
{
  lsGen gen;
  lib_gate_t *gate;
...
static lib_gate_t *find_or_create_gate(library, network) library_t *library;
network_t *network;
{
  int i;
  lib_gate_t *gate;
...
static int compare_network(net1, net2) network_t *net1, *net2;
{
  lsGen gen;
  node_t *po1, *po2;
...
static lib_class_t *find_class(library, network) library_t *library;
network_t *network;
{
  lsGen gen;
  lib_class_t *class;
...
static lib_class_t *find_or_create_class(library, gate) library_t *library;
lib_gate_t *gate;
{
  lib_class_t *class_p;
...
static void derive_dual_classes(library) library_t *library;
{
  lsGen gen;
  lib_class_t *class;
  network_t *dual;
...
static network_t *dual_network(network) network_t *network;
{
...
static double get_gate_area(gate) lib_gate_t *gate;
{
...
lib_gate_t *choose_smallest_gate(library, string) library_t *library;
char *string;
...
lib_gate_t *choose_nth_smallest_gate(library, string, order) library_t *library;
char *string;
int order;
{
  network_t *network;
...
array_t *lib_get_prims_from_class(class_p) lib_class_t *class_p;
{
  array_t **slot;
  library_t *library;
  lsGen gen1, gen2;
 ...
 */
static int lib_reduce_network(network) network_t *network;
{
  node_t *node;
  latch_t *latch;
 ...
 */
static int lib_expand_network(network) network_t *network;
{
 ...
 */
static char **lib_get_pin_delay_info(network) network_t *network;
{
#ifdef SIS
  lsGen gen;
  node_t *node;
 ...
 */
static int lib_get_latch_pin(network) network_t *network;
{
  lsGen gen;
...
static latch_time_t **lib_get_latch_time_info(network) network_t *network;
{
  node_t *node;
 ...
 */
static void lib_save_clock_info(network, clock) network_t *network;
node_t *clock;
{
  lib_clock_t *clock_info;
  node_t *clock_fanin;
...
static void lib_register_type(network) network_t *network;
{
  lsGen gen;
  node_t *node;
...
static char *node_real_name(node) node_t *node;
{
  char *name, *n;
  int len, i;
