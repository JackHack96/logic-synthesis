...
st_table *map_find_isomorphisms(network) network_t *network;
{
...
static int is_binary_tree(node, visited) node_t *node;
st_table *visited;
{
  int i;
  node_t *fanin;
...
static int tree_equal(node1, node2) node_t *node1, *node2;
{
  int eql;
...
static void mark_isomorphic_nodes(node, isomorphic_sons) node_t *node;
