...
st_table *map_find_isomorphisms(network_t *network) {
...
static int is_binary_tree(node_t *node, st_table *visited) {
    int    i;
    node_t *fanin;
...
static int tree_equal(node_t *node1, node_t *node2) {
    int eql;
...
static void mark_isomorphic_nodes(node_t *node, st_table *isomorphic_sons) {
    int    i;
    node_t *fanin;
