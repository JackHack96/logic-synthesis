...
/* ARGSUSED */
void noalg_init(network, alg) network_t *network;
fanout_alg_t *alg;
...
static void
    compute_best_one_source_one_polarity(fanout_info, entry,
                                         source_index) opt_array_t *fanout_info;
noalg_t *entry;
int source_index;
{
  delay_time_t required;
...
void noalg_insert_sinks(tree, fanout_info, from, to) array_t *tree;
