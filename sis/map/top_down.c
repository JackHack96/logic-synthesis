...
void top_down_set_mode(alg, property) fanout_alg_t *alg;
alg_property_t *property;
{ top_down_mode = property->value; }

/* ARGSUSED */
static int top_down_debug;
void top_down_set_debug(alg, property) fanout_alg_t *alg;
alg_property_t *property;
{ top_down_debug = property->value; }

/* ARGSUSED */
void top_down_init(network, alg) network_t *network;
fanout_alg_t *alg;
{
...
static int fanout_optimize(fanout_info, tree, cost)
 ...
 */
static void put_tree_in_fanout_tree_order(network, tree, node, root, root_inv,
                                          source_index, fo_table,
                                          a) network_t *network;
array_t *tree;
