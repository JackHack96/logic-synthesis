...
extern void virtual_network_update_link_required_times(
...
extern void fanout_opt_set_fanout_param(
...
extern void fanout_info_preprocess(
    /* opt_array_t *fanout_info (only one polarity at a time) */);

extern void fanout_info_free(
    /* opt_array_t *fanout_info (only one polarity at a time) */);
...
extern void fanout_tree_extract_fanout_leaves(
