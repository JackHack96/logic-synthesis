...
extern unsigned
exceed_fanout_limit(/* node_t *, double*/); /* determine if the specified load exceeds the max. allowable load */
extern double fanout_opt_get_max_load(/* node_t* */); /* find the max. allowable load on a node */
extern double
get_nth_smallest_inv_load(/* int (inverter type) */); /* find the max. allowable on an 'int'th smallest inverter*/
