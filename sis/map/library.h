...
extern lib_gate_t *lib_choose_smallest_latch (library_t *, char *, enum latch_synch_enum);
#endif

#ifdef SIS
extern lib_class_t *lib_get_class_by_type (network_t *, library_t *, latch_synch_t);
#else
