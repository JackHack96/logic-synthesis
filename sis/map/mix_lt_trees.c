...
/* ARGSUSED */
void mixed_lt_trees_init(network_t *network, fanout_alg_t *alg) { alg->optimize = mixed_lt_trees_optimize; }

/* ARGSUSED */
void mixed_lt_trees_set_max_n_gaps(fanout_alg_t *alg, alg_property_t *property) { max_n_gaps = property->value; }

/* ARGSUSED */
void mixed_lt_trees_set_max_x_index(fanout_alg_t *alg, alg_property_t *property) { max_x_index = property->value; }

/* ARGSUSED */
void mixed_lt_trees_set_max_y_index(fanout_alg_t *alg, alg_property_t *property) { max_y_index = property->value; }

/* INTERNAL INTERFACE */

static multidim_t *two_level_table;

static int mixed_lt_trees_optimize(opt_array_t *fanout_info, array_t *tree, fanout_cost_t *cost) {
    multidim_t        *table;
...
static void best_one_source(multidim_t *table, multidim_t *two_level_table, opt_array_t *fanout_info, int source_index,
                            int source_polarity, int x_index, int y_index, int n_gaps) {
...
static void select_best_source(multidim_t *table, selected_source_t *best_source, fanout_cost_t *best_cost) {
    int       source_index;
    int       source_polarity;
    lt_tree_t *entry;
...
static void
insert_mixed_lt_tree(array_t *tree, multidim_t *table, opt_array_t *fanout_info, int source_index, int source_polarity,
                     int x_index, int y_index, int n_gaps) {
...
static int
get_n_fanouts(opt_array_t *fanout_info, multidim_t *table, int source_index, int source_polarity, int x_index,
              int y_index, int n_gaps) {
    int       p, q, p_sink, q_sink, sink;
    lt_tree_t *entry;
