...
static int compare_count(x, y) count_t *x, *y;
...
static void find_tree_size(node, leaf_table, visited, tree_root) node_t *node;
st_table *leaf_table;
st_table *visited;
node_t *tree_root;
{
...
void map_print_tree_size(fp, network) FILE *fp;
network_t *network;
{
#ifdef _IBMR2
  extern void free();
