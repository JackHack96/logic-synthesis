...
/* ARGSUSED */
void lt_trees_init(network, alg) network_t *network;
fanout_alg_t *alg;
{ alg->optimize = lt_trees_optimize; }

/* ARGSUSED */
void lt_trees_set_max_n_gaps(alg, property) fanout_alg_t *alg;
...
static void best_one_source(table, two_level_table, fanout_info, source_index,
                            source_polarity, sink_index, sink_polarity,
...
static int get_n_fanouts(fanout_info, table, source_index, source_polarity,
                         sink_index, sink_polarity,
                         n_gaps) opt_array_t *fanout_info;
multidim_t *table;
int source_index;
int source_polarity;
int sink_index;
...
static void insert_lt_tree(tree, table, fanout_info, source_index,
                           source_polarity, sink_index, sink_polarity,
                           n_gaps) array_t *tree;
multidim_t *table;
opt_array_t *fanout_info;
