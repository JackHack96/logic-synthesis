 ...
 *
 * $Source: /users/pchong/CVS/sis/sis/map/cluster.c,v $
 * $Author: pchong $
 * $Revision: 1.1.1.1 $
...
clust_options_t *options;
{
  ...
  new_options.cluster_size = lazy_binary_search(min_cluster_size, max_cluster_size, max_label, nodevec, best_labelling);
