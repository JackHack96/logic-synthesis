...
network_t *cluster_under_constraint(network_t *network, clust_options_t *options) {
...
static network_t *cluster_under_size_constraint(network_t *network, clust_options_t *options) {
    int      max_label;
    array_t  *nodevec;
...
static network_t *cluster_under_depth_constraint(network_t *network, clust_options_t *options) {
    array_t         *nodevec;
    int             max_label;
...
static network_t *cluster_under_size_as_depth_constraint(network_t *network, clust_options_t *options) {
    array_t         *nodevec;
    int             max_label;
    int             min_cluster_size;
    int             max_cluster_size;
...
static void gather_cluster_statistics(network_t *network, clust_options_t *options) {
    int      i;
    array_t  *nodevec;
    int      min_cluster_size;
    int      max_cluster_size;
...
static network_t *cluster_under_best_ratio(network_t *network, clust_options_t *options) {
    int             i;
    array_t         *nodevec;
    int             min_cluster_size;
    int             max_cluster_size;
...
/* ARGSUSED */
static int label_nodes(st_table *table, array_t *nodevec, int cluster_size, int verbose) {
    int          i;
    int          label;
    node_t       *node;
    int          max_label = -1;
...
static clust_node_t *clust_node_alloc(st_table *table, node_t *node) {
    clust_node_t *node_info;
...
static int decide_label_node(st_table *table, node_t *node, clust_node_t *node_info, int cluster_size) {
    int max_fanin_label;
    int total_weight;
...
static int get_max_fanin_label(st_table *table, node_t *node) {
    int          i;
    node_t       *fanin;
    clust_node_t *node_info;
    int          max_label = -1;
...
static int compute_tfi_weight_for_given_label(st_table *table, node_t *node, int label) {
    int      weight               = 0;
...
static void
compute_tfi_for_given_label_rec(st_table *table, node_t *node, int label, st_table *visited, st_table *visited_fanins) {
    int          i;
    node_t       *fanin;
    clust_node_t *node_info;
...
static void relabel_nodes(st_table *table, array_t *nodevec, int max_label, int verbose) {
    int          i, j;
    node_t       *fanin;
    node_t       *node;
...
static void form_clusters(st_table *table, array_t *nodevec, array_t *clusters) {
    int          i;
    lsGen        gen;
    node_t       *node;
    node_t       *fanout;
...
static void put_tfi_in_cluster_rec(st_table *table, cluster_t *cluster, node_t *node, int label) {
    int          i;
    node_t       *fanin;
    clust_node_t *node_info;
...
static double duplication_ratio(network_t *network, array_t *clusters) {
    int       i;
    cluster_t *cluster;
...
static void collapse_clusters(array_t *clusters, array_t *nodevec) {
    int       i;
    node_t    *node;
    cluster_t *cluster;
...
static int sorted_node_cmp(char *obj1, char *obj2) {
...
static void collapse_cluster(cluster_t *cluster, st_table *topological_order) {
    int           i;
    st_generator  *gen;
    node_t        *net_node;
    int           order;
...
static int best_labelling(array_t *nodevec, int cluster_size) {
    int      max_label;
...
static int lazy_binary_search(int min, int max, int value, array_t *nodevec, int (*fn)()) {
    int middle;
    int min_value;
    int max_value;
    int middle_value;
...
static void clust_node_table_free(st_table *table) {
    node_t       *node;
    st_generator *gen;
    clust_node_t *node_info;
...
static void clust_node_free(clust_node_t *node_info) {
    array_free(node_info->clusters);
    FREE(node_info);
}

static void reinit_cluster_info(st_table *table) {
    node_t       *node;
    st_generator *gen;
    clust_node_t *node_info;
...
static void clusters_free(array_t *clusters) {
    int       i;
    cluster_t *cluster;
...
static void cluster_free(cluster_t *cluster) {
...
static void print_clusters(array_t *clusters) {
    int       i;
    cluster_t *cluster;
