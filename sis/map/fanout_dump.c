...
void fanout_dump_init(network, alg) network_t *network;
fanout_alg_t *alg;
{
...
/* ARGSUSED */
void fanout_dump_set_dump_threshold(alg, property) fanout_alg_t *alg;
...
static network_t *extract_fanout_network(fanout_info) opt_array_t *fanout_info;
{
  int source_polarity;
...
static void add_source_to_network(network, source,
                                  source_polarity) network_t *network;
node_t **source;
int *source_polarity;
{
  int i, n_pi;
...
static void add_sinks(network, source, fanout_info) network_t *network;
node_t *source;
...
static node_t *add_inverter_to_source(network, source) network_t *network;
node_t *source;
{
  node_t *inverter;
