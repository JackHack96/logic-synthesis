...
int find_minimum_index(array, n) delay_time_t *array;
int n;
{
  int i;
  int result;
...
void generic_fanout_optimizer(fanout_info, tree, cost, optimize_one_source,
                              extract_merge_info, build_tree)
...
VoidFn extract_merge_info;      /* (opt_array_t *fanout_info, multidim_t *table,
                                   multidim_t *merge_table) */
VoidFn build_tree;              /* (opt_array_t *fanout_info, array_t *tree,
                                   selected_source_t *source, multidim_t *table) */
{
  multidim_t *table;
  multidim_t *merge_table;
...
static void select_best_source(merge_table, best_source,
                               best_cost) multidim_t *merge_table;
...
static void get_best_one_source(merge_table, source_index, best_source,
                                best_cost) multidim_t *merge_table;
int source_index;
selected_source_t *best_source;
fanout_cost_t *best_cost;
...
static void compute_merge_cost(source_index, entry_x, entry_y,
                               cost) int source_index;
