...
multidim_t *generic_multidim_alloc(type_size, n_indices,
                                   max_index) int type_size;
int n_indices;
int *max_index;
{
  int i;
...
void multidim_free(array) multidim_t *array;
{
  FREE(array->array);
...
int multidim_array_abort(code) int code;
{
