...
void fanout_est_get_prim_pin_fanout(prim, pin, pin_info) prim_t *prim;
int pin;
pin_info_t *pin_info;
{
  node_t *input;
...
void fanout_est_compute_fanout_info(node, options) node_t *node;
...
fanout_bucket_t *fanout_est_fanout_bucket_alloc(info) multi_fanout_t *info;
{
...
void fanout_est_free_fanout_info(node) node_t *node;
{
...
delay_time_t fanout_est_get_pin_arrival_time(pin_info,
                                             pin_load) pin_info_t *pin_info;
double pin_load;
{
  double load;
  fanout_leaf_t *leaf;
...
static int get_fanin_fanout_indices(prim) prim_t *prim;
{
  int i;
  node_t *root;
  pin_info_t pin_info;
...
static node_t *fanout_est_get_pin_fanout_node(prim, pin) prim_t *prim;
int pin;
{
  prim_node_t *node;
  prim_edge_t *edge;
...
static int fanout_est_get_fanout_index(node, fanout) node_t *node;
node_t *fanout;
{
  int fanout_index;
...
static void fanout_est_get_est_fanout_leaves(node) node_t *node;
{
  node_t *source;
  array_t *fanout_tree;
  int source_polarity;
...
static void fanout_est_create_dummy_fanout_tree(node) node_t *node;
{
  int p, q;
...
static int fanout_est_get_source_polarity(fanout_point,
                                          source) node_t *fanout_point;
node_t *source;
{
  int fanout_polarity;
...
static void
    fanout_est_extract_remaining_fanout_leaves(fanout) multi_fanout_t *fanout;
{
  int i, p;
...
static void fanout_est_compute_dummy_fanout_info(node, fanout_info,
                                                 polarity) node_t *node;
...
static void fanout_est_extend_fanout_leaf(fanout, new_leaf,
                                          old_leaf) multi_fanout_t *fanout;
...
static void fanout_bucket_free(info) multi_fanout_t *info;
{
...
static double fanout_est_select_non_inverter(node, load) node_t *node;
double load;
{
  int i;
  double best_load;
