 ...
 */
int ntbdd_verify_network(net1, net2, order_method,
                         verify_method) network_t *net1;
network_t *net2;
 ...
 * time.
 */
static int verify_one_at_a_time(po_list1, pi_list1, leaves1, po_list2, pi_list2,
                                leaves2, order_method) array_t *po_list1;
array_t *pi_list1;
st_table *leaves1;
array_t *po_list2;
array_t *pi_list2;
 ...
 */
static int verify_all_together(po_list1, pi_list1, leaves1, po_list2, pi_list2,
                               leaves2, order_method) array_t *po_list1;
array_t *pi_list1;
st_table *leaves1;
array_t *po_list2;
 ...
 * have the same names.
 */
static int same_orderp(list1, list2p) array_t *list1;
...
static void report_error(pi_list1, leaves1, pi_list2, leaves2, f1, f2,
                         bad_output) array_t *pi_list1;
st_table *leaves1;
array_t *pi_list2;
st_table *leaves2;
bdd_t *f1;
