 ...
 */
bdd_t *ntbdd_node_to_local_bdd(node_t *node, bdd_manager *manager, st_table *leaves) {
    int    i;
    node_t *fanin;
 ...
 */
bdd_t *ntbdd_node_to_bdd(node_t *node, bdd_manager *manager, st_table *leaves) {
 ...
 */
static bdd_t *construct_local_bdd(node_t *node, bdd_manager *manager, st_table *leaves) {
    bdd_variableId varid;
    bdd_t          *ext_f;
    int            nliterals;
    node_t         *fanin;
 ...
 */
static bdd_t *sop(node_t *node, bdd_manager *manager, st_table *leaves, ntbdd_type_t bdd_type) {
    int   ncubes;
    int   row;
 ...
 */
static bdd_t *product(node_t *node, bdd_manager *manager, int row, st_table *leaves, ntbdd_type_t bdd_type) {
    int            nliterals;
    int            literal;
    node_cube_t    cube;
    node_t         *fanin;
 ...
 */
static bdd_t *get_node_bdd(node_t *node, bdd_manager *manager, st_table *leaves, ntbdd_type_t bdd_type) {
    bdd_t          *bdd;
    bdd_variableId varid;
