...
static int com_bdd_stats(network_t **network) {
    int         i;
    lsGen       gen;
    node_t      *node;
    bdd_t       *fn;
 ...
 */
static void convert_bdd_to_ntwk_and_print(bdd_t *fn, char *po_name, array_t *var_names) {
    network_t *network;
 ...
 */
static int com_bdd_test(network_t **network, int argc, char **argv) {
    lsGen        gen;
    node_t       *pi;
    node_t       *po;
...
static int com_bdd_create(network_t **network, int argc, char **argv) {
    bdd_manager  *manager;
    array_t      *node_vec;
    int          i, j, c, count;
...
static int com_bdd_print(network_t **network, int argc, char **argv) {
    array_t *node_vec;
    int     n, i;
    node_t  *node;
    bdd_t   *bdd;
...
static int com_bdd_size(network_t **network, int argc, char **argv) {
    array_t *node_vec;
    int     i, n;
    node_t  *node;
    bdd_t   *bdd;
...
static int com_bdd_implies(network_t **network, int argc, char **argv) {
    array_t *node_vec;
    node_t  *n1, *n2;
    int     p1, p2;
    bdd_t   *n1_bdd, *n2_bdd;
...
static int com_bdd_cofactor(network_t **network, int argc, char **argv) {
    array_t *node_vec;
    node_t  *n1, *n2, *pi;
...
static int com_bdd_smooth(network_t **network, int argc, char **argv) {
    array_t *node_vec;
    node_t  *n1, *node, *pi;
    int     status           = 0;
    array_t *smoothing_vars;
...
static int com_bdd_compose(network_t **network, int argc, char **argv) {
    array_t *node_vec;
    node_t  *n1, *n2, *n3;
    bdd_t   *bdd;
    int     status;
...
static int com_bdd_verify(network_t **network, int argc, char **argv) {
    FILE      *f1, *f2;
    network_t *net1, *net2;
    int       status;
    int       i;
...
static /* boolean */ int readit(FILE *file, char *filename, network_t **network) {
    error_init();
