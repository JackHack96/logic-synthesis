...
var_set_t *var_set_new(size) int size;
{
...
var_set_t *var_set_copy(set) var_set_t *set;
{
  int i;
  var_set_t *result = ALLOC(var_set_t, 1);
...
var_set_t *var_set_assign(result, set) var_set_t *result;
var_set_t *set;
{
  int i;
...
void var_set_free(set) var_set_t *set;
{
  FREE(set->data);
  FREE(set);
}
...
int var_set_n_elts(set) var_set_t *set;
{
  register int i, j;
...
var_set_t *var_set_or(result, a, b) var_set_t *result;
var_set_t *a;
var_set_t *b;
{
  int i;
...
var_set_t *var_set_and(result, a, b) var_set_t *result;
var_set_t *a;
var_set_t *b;
{
  int i;
...
var_set_t *var_set_not(result, a) var_set_t *result;
var_set_t *a;
{
  int i;
  unsigned int mask;
...
int var_set_get_elt(set, index) var_set_t *set;
int index;
{
...
void var_set_set_elt(set, index) var_set_t *set;
int index;
{
  unsigned int *value;
  assert(index >= 0 && index < set->n_elts);
...
void var_set_clear_elt(set, index) var_set_t *set;
int index;
{
  unsigned int *value;
  assert(index >= 0 && index < set->n_elts);
...
void var_set_clear(set) var_set_t *set;
{
  int i;
...
int var_set_intersect(a, b) var_set_t *a;
var_set_t *b;
{
  int i;
...
int var_set_is_empty(a) var_set_t *a;
{
  int i;
  for (i = 0; i < a->n_words; i++)
    if (a->data[i])
...
int var_set_is_full(a) var_set_t *a;
{
  int i;
  int value;
...
void var_set_print(fp, set) FILE *fp;
var_set_t *set;
{
  int i;
...
int var_set_equal(a, b) var_set_t *a;
var_set_t *b;
{
  int i;
...
int var_set_cmp(obj1, obj2) char *obj1;
char *obj2;
{
  int i;
...
unsigned int var_set_hash(set) var_set_t *set;
{
  int i;
