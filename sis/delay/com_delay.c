...
static int delay_sort(node1_p, node2_p) char **node1_p, **node2_p;
{
...
static int com_print_delay_constraints(network, argc, argv) network_t **network;
int argc;
char **argv;
{
  array_t *node_vec;
...
static int com_print_delay(network, argc, argv) network_t **network;
int argc;
char **argv;
{
...
static int com_set_delay(network, argc, argv) network_t **network;
int argc;
char **argv;
{
