...
/*
     ...
     to another.
*/
static double tdc_get_flslack(bdd, group) bdd_t *bdd;
pin_group_t *group;
{
  int i;
...
*/
static double tdc_group_delay(bdd, group, options) bdd_t *bdd;
pin_group_t *group;
int options;
{
...
*/
static void do_girdle(bdd, first_src, last_src, visited, counter) bdd_t *bdd;
...
*/
static int girdle(bdd, group) bdd_t *bdd;
pin_group_t *group;
{
  st_table *visited, *counter;
