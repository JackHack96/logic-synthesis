 ...
 */
sis_clock_t *clock_create(name) char *name;
{
  int i, j;
  sis_clock_t *clock;
 ...
 */
void clock_free(clock) sis_clock_t *clock;
{
  int i, j;
 ...
 * definition
 */
int clock_add_to_network(network, clock) network_t *network;
sis_clock_t *clock;
{
  lsHandle handle;
...
void clock_set_cycletime(network, value) network_t *network;
double value;
{
...
double clock_get_cycletime(network) network_t *network;
{
  int flag = clock_get_current_setting_index(network);
 ...
 */
int clock_delete_from_network(network, clock) network_t *network;
sis_clock_t *clock;
{
  int i, j;
  lsGen gen;
 ...
 */
void network_clock_free(network) network_t *network;
{
  int i;
  lsGen gen;
  sis_clock_t *clock;
 ...
 */
void network_clock_dup(old, new) network_t *old, *new;
{
  int i, j;
  char *dummy;
  lsGen gen, gen2;
 ...
 */
void network_clock_alloc(network) network_t *network;
{
  network_clock_t *clk;
 ...
 */
static int clock_is_dependent(edge1, edge2) clock_edge_t edge1, edge2;
{
  lsGen gen;
  int status;
  char *dummy;
...
static void clock_add_no_check_dependency(setting, edge1,
                                          edge2) clock_setting_t setting;
 ...
 */
int clock_add_dependency(edge1, edge2) clock_edge_t edge1, edge2;
{
  int j;
  char *dummy;
  lsGen gen1, gen2;
 ...
 */
void clock_remove_dependency(edge1, edge2) clock_edge_t edge1, edge2;
{
  lsGen gen;
  int delete;
  char *dummy;
 ...
 */
lsGen clock_gen_dependency(edge) clock_edge_t edge;
{
  int j;
 ...
 */
sis_clock_t *clock_get_by_name(network, clk_name) network_t *network;
char *clk_name;
{
  lsGen gen;
  char *dummy;
 ...
 */
char *clock_name(clock) sis_clock_t *clock;
{ return clock->name; }
 ...
 */
void clock_set_current_setting(network, mode) network_t *network;
 ...
 */
clock_setting_t clock_get_current_setting(network) network_t *network;
 ...
 */
int clock_get_current_setting_index(network) network_t *network;
{
 ...
 */
int network_num_clock(network) network_t *network;
{ return lsLength(CLOCK(network)->clock_defn); }

int clock_num_dependent_edges(edge) clock_edge_t edge;
{
  int flag, num;
  network_t *net;
 ...
 */
int clock_set_parameter(clock_edge, parameter, value) clock_edge_t clock_edge;
...
double clock_get_parameter(clock_edge, parameter) clock_edge_t clock_edge;
clock_param_t parameter;
{
  network_t *network;
  int which_edge, flag;
