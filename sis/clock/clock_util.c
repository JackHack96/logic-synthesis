 ...
 */
sis_clock_t *clock_get_transitive_clock(network, node, model, offset,
                                        phasep) network_t *network;
node_t *node;
delay_model_t model;
delay_time_t *offset;
...
static sis_clock_t *clock_get_transitive_recur(network, node, model, offset,
                                               phasep) network_t *network;
node_t *node;
delay_model_t model;
delay_time_t *offset;
