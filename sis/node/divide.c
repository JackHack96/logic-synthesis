...
static div_cube_t *divide_setup_divisor(sf) pset_family sf;
{
...
static div_cube_t *
    divide_setup_dividend(head, sf, divisor_support) register div_cube_t *head;
pset_family sf;
...
static div_cube_t *divide_find_classes(list, fullset) div_cube_t **list;
...
void divide_finale(list, quotient, divisor_ncube, q_sf, r_sf) div_cube_t *list,
    *quotient;
int divisor_ncube;
...
static int list_compare(p, q) div_cube_t *p, *q;
{
  int x;
...
static node_t *divide_single_cube(f, g, r_node) node_t *f, *g;
node_t **r_node;
{
...
static node_t *divide_single_literal(f, g, r_node) node_t *f, *g;
node_t **r_node;
{
  node_t *q_node;
  pset_family q_sf, r_sf;
...
node_t *node_div(f, g, r_node) node_t *f, *g;
node_t **r_node;
{
