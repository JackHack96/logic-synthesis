...
static void dump_set(fp, setp) FILE *fp;
pset setp;
{
  int i, n;
...
static void dump_list(list) div_cube_t *list;
{
  div_cube_t *p;
...
static void dump_fanin(fanin, nfanin) node_t **fanin;
int nfanin;
{
  int i;
...
static div_cube_t *divide_setup_divisor(pset_family sf) {
...
static div_cube_t *divide_setup_dividend(register div_cube_t *head, pset_family sf, register pset divisor_support) {
    register pset       last, p;
...
static div_cube_t *divide_find_classes(div_cube_t **list, register pset fullset) {
...
void divide_finale(div_cube_t *list, div_cube_t *quotient, int divisor_ncube, pset_family q_sf, pset_family r_sf) {
...
static int list_compare(div_cube_t *p, div_cube_t *q) {
    int x;
...
static node_t *divide_single_cube(node_t *f, node_t *g, node_t **r_node) {
...
static node_t *divide_single_literal(node_t *f, node_t *g, node_t **r_node) {
    node_t        *q_node;
...
node_t *node_div(node_t *f, node_t *g, node_t **r_node) {
