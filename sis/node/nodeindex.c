...
void nodeindex_free(table) nodeindex_t *table;
{
...
nodeindex_insert(table, node) nodeindex_t *table;
node_t *node;
{
  char *value;
  int index;
...
nodeindex_indexof(table, node) nodeindex_t *table;
node_t *node;
{
  char *value;
...
node_t *nodeindex_nodeof(table, index) nodeindex_t *table;
int index;
