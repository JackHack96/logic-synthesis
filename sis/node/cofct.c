...
void node_algebraic_cofactor(node, fanin, p, q, r) node_t *node, *fanin;
node_t **p, **q, **r;
{
  register int i;
...
static node_t *fast_cofactor(node, fanin, phase) node_t *node, *fanin;
int phase;
{
  register int i;
...
node_t *node_cofactor(node, cube) node_t *node, *cube;
{
