...
void node_algebraic_cofactor(node_t *node, node_t *fanin, node_t **p, node_t **q, node_t **r) {
    register int  i;
...
static node_t *fast_cofactor(node_t *node, node_t *fanin, int phase) {
    register int  i;
...
node_t *node_cofactor(node_t *node, node_t *cube) {
