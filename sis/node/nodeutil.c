...
node_t *node_dup(register node_t *old) {
    register node_t   *new;
    register daemon_t *d;
...
node_t **nodevec_dup(register node_t **fanin, int nin) {
    register int    i;
...
void node_invalid(register node_t *node) {
    register daemon_t *d;
...
void node_register_daemon(node_daemon_type_t type, void (*func)()) {
    daemon_t *daemon;
...
network_t *node_network(node_t *node) { return node->network; }
