...
com_div(network, argc, argv) network_t **network;
int argc;
char **argv;
{
  array_t *node_vec;
...
com_sim(network, argc, argv) network_t **network;
int argc;
char **argv;
{
  array_t *node_vec;
  ...
  for (i = 0; i < array_n(node_vec); i++) {
    ...
    case NODE_PO:
      break;
    default:
      (void)node_simplify_replace(node, NIL(node_t), mode);
    }
  }
  array_free(node_vec);
  return 0;
...
com_cof(network, argc, argv) network_t **network;
int argc;
char **argv;
{
  array_t *node_vec;
...
com_wd(network, argc, argv) network_t **network;
int argc;
char **argv;
{
  array_t *node_vec;
...
com_scc(network, argc, argv) network_t **network;
int argc;
char **argv;
{
  array_t *node_vec;
...
com_invert(network, argc, argv) network_t **network;
int argc;
char **argv;
{
  array_t *node_vec;
