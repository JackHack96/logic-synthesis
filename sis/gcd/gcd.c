...
array_t *gcd_prime_factorize(node_t *f) {
...
node_t *gcd_nodevec(array_t *nodevec) {
...
static node_t *find_prime_factor(node_t *f, node_t **cofactor) {
...
node_t *internal_gcd(node_t *q, node_t *r) {
...
node_t *make_cube_free(node_t *f, node_t **f_cube) {
    node_t *r;
