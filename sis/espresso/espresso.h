...
/* cofactor.c */    extern int binate_split_select(pcube *, pcube,
                                                   pcube, int);
...
/* cvrm.c */    extern int cubelist_partition(pcube *, pcube **, pcube **, unsigned int);
...
/* exact.c */    extern pcover minimize_exact_literals(pcover, pcover, pcover, int);
...
/* hack.c */    extern int find_dc_inputs(pPLA, symbolic_list_t *, int, int, pcover *, pcover *);

/* hack.c */    extern int find_inputs
        (pcover, pPLA, symbolic_list_t
        *,
...
/* hack.c */    extern int symbolic_hack_labels(pPLA, symbolic_t *, pset, int, int, int);
...
/* irred.c */    extern void irred_split_cover(pcover, pcover, pcover *, pcover *, pcover *);
...
/* unate.c */    extern pset_family unate_intersect(pset_family, pset_family, bool);
