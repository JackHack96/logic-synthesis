...
void set_pair(pPLA PLA) { set_pair1(PLA, TRUE); }
...
int minimize_pair(ppair pair) {
    ...
    switch (pair_minim_strategy) {
        case 2: EXEC_S(phase_assignment(global_PLA, 0), "OPO       ", global_PLA->F);
            ...
            break;
        case 1: EXEC_S(global_PLA->F =
                               minimize_exact(global_PLA->F, global_PLA->D, global_PLA->R, 1),
                       "EXACT     ", global_PLA->F);
            break;
        case 0: EXEC_S(global_PLA->F =
                               espresso(global_PLA->F, global_PLA->D, global_PLA->R),
