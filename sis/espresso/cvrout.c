...
char *fmt_cube(register pcube c, register char *out_map, register char *s) {
...
void print_cube(register FILE *fp, register pcube c, register char *out_map) {
...
void print_expanded_cube(register FILE *fp, register pcube c, pcube phase) {
    register int i, var, ch;
    char         *out_map;
