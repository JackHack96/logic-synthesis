...
pcover essential(Fp, Dp) IN pcover *Fp, *Dp;
{
...
/*
    ...
    does not contain c.
*/
bool essen_cube(F, D, c) IN pcover F, D;
IN pcube c;
{
  pcover H, FD;
  pcube *H1;
 ...
 */
pcover cb_consensus(T, c) register pcover T;
register pcube c;
{
 ...
 */
pcover cb_consensus_dist0(R, p, c) pcover R;
register pcube p, c;
{
  int var;
  bool got_one;
