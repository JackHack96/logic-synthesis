 ...
 */
int com_astg_syn(network_t **network, int argc, char **argv) {
    network_t *new_net;
    int       c, skip_flow;
...
int com_astg_print_stat(network_t **network, int argc, char **argv) {
    astg_graph *stg;
...
int com_astg_print_sg(network_t **network, int argc, char **argv) {
