...
network_t *astg_encode(stg, astg, heuristic) graph_t *stg;
astg_graph *astg;
int heuristic;
{
  network_t *network;
...
static void dic_add(l1, l2, r1, r2, n, dic, list) int l1, l2, r1, r2, n;
pset dic;
dic_family_t *list;
{
...
static int extract_and_solve_cons(stg, heuristic) graph_t *stg;
int heuristic;
{
  edge_t *edge;
...
static void encode_stg(stg, cover, table, prime_list) graph_t *stg;
sm_row *cover;
sm_matrix *table;
...
static network_t *stg_to_net(stg, astg) graph_t *stg;
astg_graph *astg;
{
  network_t *network;
  FILE *fp;
