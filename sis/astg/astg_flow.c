...
array_t *astg_check_new_state(finfo, new_state) astg_flow_t *finfo;
...
static int flow_state(flow_info, new_state) astg_flow_t *flow_info;
astg_scode new_state;
{
...
static astg_bool astg_flow_check_csc(stg, verbose) astg_graph *stg;
astg_bool verbose;
{
...
static void astg_flow_check_redundant(stg) astg_graph *stg;
{
  astg_generator gen;
  astg_place *p;
  astg_trans *t;
