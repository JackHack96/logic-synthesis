...
static void pr_path(astg_graph *stg, char *s) {
    astg_generator gen;
    astg_vertex    *v;
...
static int check_redundant(astg_graph *stg, void *data) {
...
static float astg_calc_delay(astg_graph *stg) {
    float          rc = 0.0;
    astg_vertex    *v;
    astg_generator gen;
...
static int check_cycles(astg_graph *stg, void *data) {
...
float astg_longest_cycle(astg_graph *stg) {
...
int astg_select_cycle(astg_graph *stg, astg_trans *thru_trans, int cycle_n, astg_bool find_longest,
                      astg_bool add_to_set) {
    cycle_info  cinfo_rec;
    char        set_name[180];
    astg_vertex *v;
    int         n, n_cycle;
