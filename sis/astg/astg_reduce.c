...
int astg_print_component(i, varray, stream) int i;
array_t *varray;
FILE *stream;
{
  astg_vertex *v;
...
static array_t *get_key_vertices(stg, type, ubound) astg_graph *stg;
int type;
int *ubound;
{
  astg_generator gen;
...
static int n_undead_fanin(v) astg_vertex *v;
{
  astg_generator gen;
  int rc = 0;
  astg_edge *e;
...
static int n_undead_fanout(v) astg_vertex *v;
{
  astg_generator gen;
  int rc = 0;
  astg_edge *e;
...
static void del_mg_trans(stg, trans, depth) astg_graph *stg;
astg_vertex *trans;
int depth;
{
  astg_edge *e1, *e2;
...
static void del_sm_place(stg, place, depth) astg_graph *stg;
astg_vertex *place;
int depth;
{
  astg_generator gen1, gen2;
...
static int cmp_vertex(obj1, obj2) char *obj1, *obj2;
{
...
static int cmp_component(comp1, comp2) array_t *comp1, *comp2;
{
...
static int add_component(cc, n, fdata) array_t *cc;
int n; /*  ARGSUSED */
void *fdata;
{
...
static void do_sm_reduce(stg, component_array) astg_graph *stg;
...
static void do_mg_reduce(stg, component_array) astg_graph *stg;
array_t *component_array;
{
  astg_vertex *v;
  astg_generator gen1, gen2;
...
static void gen_sm_allocation(stg, component_array, t, n) astg_graph *stg;
array_t *component_array;
array_t *t;
int n;
{
...
static void gen_mg_allocation(stg, component_array, t, n) astg_graph *stg;
array_t *component_array;
array_t *t;
int n;
{
...
static astg_retval check_reductions(stg, type, verbose) astg_graph *stg;
...
astg_retval get_sm_comp(stg, verbose) astg_graph *stg;
astg_bool verbose;
{
...
astg_retval get_mg_comp(stg, verbose) astg_graph *stg;
astg_bool verbose;
{
  long stg_count = astg_change_count(stg);
...
void free_components(component_array) array_t *component_array;
{
  int i;
