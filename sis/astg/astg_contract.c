...
static void print_place_info(p) astg_place *p;
{
  astg_generator gen;
  astg_edge *e;
...
static astg_bool check_62(stg, te) astg_graph *stg;
astg_vertex *te;
{
  astg_edge *e1, *e2, *e3;
  astg_vertex *v, *p1, *p2;
...
static astg_bool check_68a1(te) astg_vertex *te;
{
  astg_edge *e;
  astg_vertex *place;
  astg_generator gen;
...
static astg_bool check_68a2(te) astg_vertex *te;
{
  astg_edge *e;
  astg_vertex *place;
  astg_generator gen;
...
static astg_bool check_68a(te) astg_vertex *te;
{
  astg_bool pass_68a;
...
static int mark_flag1(stg, data)
    astg_graph *stg; /*u set flag1 to ASTG_TRUE for all path vertices.	*/
void *data;          /* ARGSUSED */
{
  astg_vertex *v;
  astg_generator gen;
...
static int check_flag1(stg, data)
    astg_graph *stg; /*i return 1 if any flag1 is set on path.	*/
void *data;          /* ARGSUSED */
{
  astg_generator gen;
  astg_vertex *v;
...
static astg_bool check_68b(stg, te) astg_graph *stg;
astg_vertex *te;
{
...
static astg_bool check_68(stg, te) astg_graph *stg;
astg_vertex *te;
{ return check_68a(te) && check_68b(stg, te); }

static astg_bool can_contract_trans(stg, te, keep_fc) astg_graph *stg;
astg_vertex *te;
astg_bool keep_fc; /*i maintain free choice property?	*/
{
...
static astg_bool can_contract(stg, sig_p, keep_fc) astg_graph *stg;
astg_signal *sig_p;
astg_bool keep_fc;
{
...
static astg_bool pure_place_simple(p) astg_vertex *p;
{
...
static void elim_trans(stg, te) astg_graph *stg;
astg_vertex *te;
{
  astg_edge *e1, *e2, *ex;
...
static void keep_in_sig(stg, sv, outsig) astg_graph *stg; /* ARGSUSED */
astg_trans *sv;
astg_signal *outsig;
{
...
static void elim_sig(g, sig_p) astg_graph *g;
astg_signal *sig_p;
{
  astg_graph *stg = g;
  astg_generator gen;
...
astg_graph *astg_contract(stg, outsig, keep_fc) astg_graph *stg;
astg_signal *outsig;
astg_bool keep_fc;
{
  astg_graph *cstg;
