...
static int find_per(stg, data) astg_graph *stg; /* ARGSUSED */
...
int astg_set_opp(stg, subset) astg_graph *stg;
astg_bool subset;
{
  int result = 0;
  astg_signal *sig_p;
...
static int make_mgc_persistent(stg, modify) astg_graph *stg;
...
int make_persistent(stg, modify) astg_graph *stg;
astg_bool modify;
{
