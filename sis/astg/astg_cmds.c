...
static int com_astg_flow(network_t **network_p, int argc, char **argv) {
    int         c;
    char        *outfile;
    ...
    while ((c = util_getopt(argc, argv, "xo:l:q")) != EOF) {
        switch (c) {
            case 'x':full_checks = ASTG_FALSE;
                break;
            case 'l':latch_type = util_optarg;
                break;
            case 'o':outfile = util_strsav(util_optarg);
                del_out      = ASTG_FALSE;
                break;
            case 'q':verbose = ASTG_FALSE;
                break;
            default:result = ASTG_BAD_OPTION;
                break;
        }
    }
...
static int com_astg_read(network_t **network_p, int argc, char **argv) {
    int         c;
    char        *infile;
    char        alt_infile[80];
...
static int com_astg_write(network_t **network_p, int argc, char **argv) {
    astg_retval result      = ASTG_OK;
...
static int astg_count_cycles(astg_graph *stg, void *data) {
    /*	Return 1 to count number of simple cycles in the net. */
    /* ARGSUSED */
    return 1;
}

static int com_astg_cycle(network_t **network_p, int argc, char **argv) {
    int         c;
    astg_retval result           = ASTG_OK;
    astg_graph  *stg;
    io_t        source;
    ...
    while ((c = util_getopt(argc, argv, "t:lac")) != EOF) {
        switch (c) {
            case 'a':append = ASTG_TRUE;
                break;
            case 'l':longest = ASTG_TRUE;
                break;
            case 't':tname = util_optarg;
                break;
            case 'c':count_em = ASTG_TRUE;
                break;
            default:result = ASTG_BAD_OPTION;
                break;
        }
...
static int print_stg_comp(array_t *varray, int n, void *extra) {
    int         i;
    astg_vertex *v;
...
static int com_astg_lockgraph(network_t **network_p, int argc, char **argv) {
    int         c;
    astg_retval result  = ASTG_OK;
    int         n_comp;
    astg_graph  *stg;
...
static int com_astg_persist(network_t **network_p, int argc, char **argv) {
    int         c;
    astg_retval result = ASTG_OK;
    astg_graph  *stg;
...
static int com_astg_irred(network_t **network_p, int argc, char **argv) {
    int         c;
    astg_retval result = ASTG_OK;
    astg_bool   modify = ASTG_TRUE;
    astg_graph  *curr_stg;
...
static int com_astg_current(network_t **network_p, int argc, char **argv) {
    int         c;
    astg_retval result = ASTG_OK;
    int         n_comp1, n_comp2;
    astg_graph  *curr_stg;
    ...
    while ((c = util_getopt(argc, argv, "d:")) != EOF) {
        switch (c) {
            case 'd':astg_debug_flag = atoi(util_optarg);
                break;
            default:result = ASTG_BAD_OPTION;
                break;
        }
...
static int com_astg_marking(network_t **network_p, int argc, char **argv) {
    astg_retval    result        = ASTG_OK;
    astg_graph     *stg;
    astg_place     *p;
    io_t           source;
    ...
    while ((c = util_getopt(argc, argv, "s")) != EOF) {
        switch (c) {
            case 's':by_state_code = ASTG_TRUE;
                break;
            default:result = ASTG_BAD_OPTION;
                break;
        }
...
static int astg_print_component_pieces(array_t *vertices, int n, void *fdata) {
...
static void select_comp(astg_graph *stg, array_t *comp, char *comp_name, int comp_n) {
    astg_vertex    *v;
    int            n, n_scc;
    astg_generator gen;
...
static int com_astg_mgc(network_t **network_p, int argc, char **argv) {
    astg_retval result = ASTG_OK;
    astg_graph  *stg;
    int         c, n, status;
    array_t     *comp;
...
static int com_astg_smc(network_t **network_p, int argc, char **argv) {
    astg_retval result = ASTG_OK;
    astg_graph  *stg;
    int         c, n, status;
    array_t     *comp;
...
static int com_astg_contract(network_t **network_p, int argc, char **argv) {
    astg_retval result  = ASTG_OK;
    astg_signal *sig_p;
...
void astg_basic_cmds(astg_bool do_init) {
    astg_cmd_rec *p;
    int          i;
