...
void astg_do_daemons(stg1, stg2, type) astg_graph *stg1, *stg2;
...
extern void astg_register_daemon(type, daemon) astg_daemon_enum type;
astg_daemon daemon;
{
...
extern void *astg_get_slot(stg, slot_id) astg_graph *stg;
...
extern void astg_set_slot(stg, slot_id, value) astg_graph *stg;
astg_slot_enum slot_id;
void *value;
{
...
extern astg_bool astg_is_marked_graph(stg) astg_graph *stg;
{
...
extern astg_bool astg_is_state_machine(stg) astg_graph *stg;
{
...
extern astg_bool astg_is_free_choice_net(stg) astg_graph *stg;
{
...
astg_bool astg_is_place_simple(g) astg_graph *g;
{
...
astg_bool astg_is_pure(g) astg_graph *g;
{
  astg_generator gen1, gen2, gen3;
  astg_vertex *p, *p2;
  astg_edge *e1, *e2;
...
static int astg_report_cycle(g) astg_graph *g;
{
  astg_generator gen;
  astg_vertex *v;
  int rc;
...
static int astg_cycles(g, v) astg_graph *g;
astg_vertex *v;
{
  astg_generator gen;
  int rc = 0;
...
int astg_simple_cycles(g, target_v, f, f_data, subset) astg_graph *g;
...
static void astg_ts_dfs(g, v, num_p) astg_graph *g;
astg_vertex *v;
int *num_p;
{
  astg_generator gen;
...
static void astg_cc_dfs(v, vcomp, component_n) astg_vertex *v;
array_t *vcomp;
int component_n;
{
  astg_generator gen;
...
static void astg_scc_dfs(v, vcomp, component_n) astg_vertex *v;
array_t *vcomp;
int component_n;
{
  astg_generator gen;
...
static int astg_find_cycles(v) astg_vertex *v;
{
  astg_generator gen;
  astg_edge *e;
  int rc = 0;
...
int astg_has_cycles(g) astg_graph *g;
{
  astg_generator gen;
  astg_vertex *v;
  int n_cycles;
...
void astg_print_path(stg, stream) astg_graph *stg;
FILE *stream;
{
  astg_generator gen;
  astg_vertex *v;
...
void astg_print(g, stream) astg_graph *g;
FILE *stream;
{
  astg_generator gen;
  astg_vertex *v;
