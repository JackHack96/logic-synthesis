...
if ((
newrelation = (char *) calloc((unsigned) net_num + 1, sizeof(char))
) == (char *) 0) {
fprintf(stderr,
"Insufficient memory for newrelation in inter_graph\n");
exit(-1);
}
...
/* "constrptr1" points to the first operand of the intersection
   operation */
for (
constrptr1 = graph_levels[i];
constrptr1 != (CONSTRAINT_E *) 0;
...
/* "constrptr2" points to the second operand of the intersection
   operation */
for (
constrptr2 = graph_levels[k];
constrptr2 != (CONSTRAINT_E *) 0;
...
for (
temptr = graph_levels[inter_level];
temptr != (CONSTRAINT_E *) 0;
temptr = temptr->next
) {
if (
...
new->
next = graph_levels[inter_level];
graph_levels[inter_level] =
new;
countnewconstr++;
}
...
new->
next = graph_levels[graph_depth - 1];
graph_levels[graph_depth-1] =
new;
                ...
                for (sonconstr = graph_levels[j]; sonconstr != (CONSTRAINT_E *) 0;
                    ...
                    if (p_incl_s(ftconstr->relation, sonconstr->relation) == 1 &&
                        ...
                        if (temptr1 == (SONS_LINK *) 0 &&
                            ...
                            if ((sons_link = (SONS_LINK *) calloc((unsigned) 1, sizeof(SONS_LINK))) ==
                                (SONS_LINK *) 0) {
                ...
                for (ftconstr = graph_levels[j]; ftconstr != (CONSTRAINT_E *) 0;
                    ...
                    if (p_incl_s(ftconstr->relation, sonconstr->relation) == 1 &&
                        ...
                        if (temptr1 == (FATHERS_LINK *) 0 &&
                            temptr2 == (CONSTRAINT_E *) 0) {
                            if ((fathers_link = (FATHERS_LINK *) calloc((unsigned) 1, sizeof(FATHERS_LINK))) ==
                                (FATHERS_LINK *) 0) {
