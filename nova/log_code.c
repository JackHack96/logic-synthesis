...
newcode(hypervertices[0]
.code, source, symblemes);
strcpy(symblemes[source]
.code, hypervertices[0].code);
symblemes[source].
code_status = FIXED;
hypervertices[0].
ass_status = TRUE;
...
newcode(hypervertices[savevert]
.code, j, symblemes);
strcpy(symblemes[j]
.code, hypervertices[savevert].code);
symblemes[j].
code_status = FIXED;
hypervertices[savevert].
ass_status = TRUE;
