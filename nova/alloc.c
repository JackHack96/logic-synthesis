...
newinputrow(char *input, char *pstate, char *nstate, char *output) {
    INPUTTABLE *new;

    if ((new = (INPUTTABLE *) calloc((unsigned) 1, sizeof(INPUTTABLE))) ==
        (INPUTTABLE *) 0) {
        fprintf(stderr, "Insufficient memory for inputtable");
        exit(-1);
    }

    if ((new->input = (char *) calloc((unsigned) strlen(input) + 1,
                                      sizeof(char))) == (char *) 0) {
        fprintf(stderr, "Insufficient memory for inputtable->input");
        exit(-1);
    }

    if ((new->pstate = (char *) calloc((unsigned) strlen(pstate) + 1,
                                       sizeof(char))) == (char *) 0) {
        fprintf(stderr, "Insufficient memory for inputtable->pstate");
        exit(-1);
    }

    if ((new->nstate = (char *) calloc((unsigned) strlen(nstate) + 1,
                                       sizeof(char))) == (char *) 0) {
        fprintf(stderr, "Insufficient memory for inputtable->nstate");
        exit(-1);
    }

    if ((new->output = (char *) calloc((unsigned) strlen(output) + 1,
                                       sizeof(char))) == (char *) 0) {
...
CONSTRAINT *newconstraint(char *relation, int card, int level) {
    CONSTRAINT *new;

    if ((new = (CONSTRAINT *) calloc((unsigned) 1, sizeof(CONSTRAINT))) ==
        (CONSTRAINT *) 0) {
        fprintf(stderr, "Insufficient memory for constraint");
        exit(-1);
    }

    if ((new->relation = (char *) calloc((unsigned) strlen(relation) + 1,
                                         sizeof(char))) == (char *) 0) {
    ...
    if ((new->next_states = (char *) calloc((unsigned) strlen(relation) + 1,
                                            sizeof(char))) == (char *) 0) {
...
int newcode(char *code, int which_element, SYMBLEME *symbleme_type) {
    CODE *new;
    ...
    if ((new->value = (char *) calloc((unsigned) strlen(code) + 1, sizeof(char))) ==
        (char *) 0) {
...
CONSTRAINT_E *newconstraint_e(char *relation, int card) {
    CONSTRAINT_E *new;

    if ((new = (CONSTRAINT_E *) calloc((unsigned) 1, sizeof(CONSTRAINT_E))) ==
        (CONSTRAINT_E *) 0) {
        fprintf(stderr, "Insufficient memory for constraint");
        exit(-1);
    }
...
int array_alloc(void) {
    ...
    if ((states = (SYMBLEME *) calloc((unsigned) statenum, sizeof(SYMBLEME))) ==
        (SYMBLEME *) 0) {
    ...
    for (i = 0; i < statenum; i++) {
        if ((states[i].name = (char *) calloc((unsigned) MAXSTRING, sizeof(char))) ==
            (char *) 0) {
    ...
    for (i = 0; i < statenum; i++) {
        if ((states[i].code = (char *) calloc((unsigned) st_codelength + 1,
                                              sizeof(char))) == (char *) 0) {
    ...
    for (i = 0; i < statenum; i++) {
        if ((states[i].best_code = (char *) calloc((unsigned) st_codelength + 1,
                                                   sizeof(char))) == (char *) 0) {
    ...
    for (i = 0; i < statenum; i++) {
        if ((states[i].exact_code = (char *) calloc((unsigned) statenum + 1,
                                                    sizeof(char))) == (char *) 0) {
    ...
    for (i = 0; i < statenum; i++) {
        if ((states[i].exbest_code = (char *) calloc((unsigned) statenum + 1,
                                                     sizeof(char))) == (char *) 0) {
    ...
    if (ISYMB) {
        ...
        if ((inputs = (SYMBLEME *) calloc((unsigned) inputnum, sizeof(SYMBLEME))) ==
            (SYMBLEME *) 0) {
        ...
        for (i = 0; i < inputnum; i++) {
            if ((inputs[i].name = (char *) calloc((unsigned) MAXSTRING,
                                                  sizeof(char))) == (char *) 0) {
        ...
        for (i = 0; i < inputnum; i++) {
            if ((inputs[i].code = (char *) calloc((unsigned) inp_codelength + 1,
                                                  sizeof(char))) == (char *) 0) {
        ...
        for (i = 0; i < inputnum; i++) {
            if ((inputs[i].best_code = (char *) calloc((unsigned) inp_codelength + 1,
                                                       sizeof(char))) == (char *) 0) {
        ...
        for (i = 0; i < inputnum; i++) {
            if ((inputs[i].exact_code = (char *) calloc((unsigned) inputnum + 1,
                                                        sizeof(char))) == (char *) 0) {
        ...
        for (i = 0; i < inputnum; i++) {
            if ((inputs[i].exbest_code = (char *) calloc((unsigned) inputnum + 1,
                                                         sizeof(char))) == (char *) 0) {
    ...
    if ((levelarray = (CONSTRAINT **) calloc(
            (unsigned) symblemenum, sizeof(CONSTRAINT *))) == (CONSTRAINT **) 0) {
        fprintf(stderr, "Insufficient memory for levelarray");
        exit(-1);
    }

    if ((cardarray = (CONSTRAINT **) calloc(
            (unsigned) symblemenum, sizeof(CONSTRAINT *))) == (CONSTRAINT **) 0) {
    ...
    if ((graph_levels = (CONSTRAINT_E **) calloc((unsigned) graph_depth,
                                                 sizeof(CONSTRAINT_E *))) ==
        (CONSTRAINT_E **) 0) {
    ...
    if (ISYMB)
        max_codelength = max(st_codelength, inp_codelength);
    else
        max_codelength = st_codelength;

    num_codes = power(2, max_codelength);

    if ((hypervertices = (HYPERVERTEX *) calloc(
            (unsigned) num_codes, sizeof(HYPERVERTEX))) == (HYPERVERTEX *) 0) {
        fprintf(stderr, "Insufficient memory for hypervertices");
        exit(-1);
    }

    for (i = 0; i < num_codes; i++) {
        if ((hypervertices[i].code = (char *) calloc((unsigned) max_codelength + 1,
                                                     sizeof(char))) == (char *) 0) {
    ...
    if ((zeroutput = (int *) calloc((unsigned) statenum, sizeof(int))) ==
        (int *) 0) {
...
int new_outsymbol(char *element, int lab) {
    OUTSYMBOL *new;

    if ((new = (OUTSYMBOL *) calloc((unsigned) 1, sizeof(OUTSYMBOL))) ==
        (OUTSYMBOL *) 0) {
        fprintf(stderr, "Insufficient memory for outsymbol");
        exit(-1);
    }

    if ((new->element = (char *) calloc((unsigned) strlen(element) + 1,
                                        sizeof(char))) == (char *) 0) {
...
int new_order_relation(int row, int column) {
    ORDER_RELATION *new;

    if ((new = (ORDER_RELATION *) calloc((unsigned) 1, sizeof(ORDER_RELATION))) ==
        (ORDER_RELATION *) 0) {
...
int new_order_path(int row, int column) {
    ORDER_PATH *new;

    if ((new = (ORDER_PATH *) calloc((unsigned) 1, sizeof(ORDER_PATH))) ==
        (ORDER_PATH *) 0) {
...
IMPLICANT *newimplicant(char *row, int state) {
    IMPLICANT *new;

    if ((new = (IMPLICANT *) calloc((unsigned) 1, sizeof(IMPLICANT))) ==
        (IMPLICANT *) 0) {
        fprintf(stderr, "Insufficient memory for implicant");
        exit(-1);
    }

    if ((new->row = (char *) calloc((unsigned) strlen(row) + 1, sizeof(char))) ==
        (char *) 0) {
...
int array_alloc2(void) {

    int i;

    if ((order_graph = (ORDER_RELATION **) calloc((unsigned) statenum,
                                                  sizeof(ORDER_RELATION *))) ==
        (ORDER_RELATION **) 0) {
    ...
    if ((path_graph = (ORDER_PATH **) calloc(
            (unsigned) statenum, sizeof(ORDER_PATH *))) == (ORDER_PATH **) 0) {
        fprintf(stderr, "Insufficient memory for order_graph");
        exit(-1);
    }
    ...
    if ((order_array = (char **) calloc((unsigned) statenum, sizeof(char *))) ==
        (char **) 0) {
        fprintf(stderr, "Insufficient memory for 'order_array'");
        exit(-1);
    }
    for (i           = 0; i < statenum; i++) {
        if ((order_array[i]      = (char *) calloc((unsigned) statenum + 1,
                                                   sizeof(char))) == (char *) 0) {
    ...
    if ((gain_array = (int *) calloc((unsigned) statenum, sizeof(int))) ==
        (int *) 0) {
    ...
    if ((select_array = (int *) calloc((unsigned) statenum, sizeof(int))) ==
        (int *) 0) {
