...
if (i >= argc) {
fprintf(stderr,
"no argument for input code length!\n");
exit(-1);
}
...
if (i >= argc) {
fprintf(stderr,
"no argument for state code length!\n");
exit(-1);
}
...
if (i >= argc) {
fprintf(stderr,
"no argument for cost function in sa!\n");
exit(-1);
}
cost_function = atoi(argv[i]);
if (cost_function < 0 || cost_function > 1) {
fprintf(stderr,
"Cost function of sa may be only 0 or 1!\n");
exit(-1);
}
}
...
if (i >= argc) {
fprintf(stderr,
"no argument for # of moves in sa!\n");
exit(-1);
}
num_moves = atoi(argv[i]);
if (num_moves < 1) {
fprintf(stderr,
"Invalid # of moves in sa (non-pos. int.)!\n");
exit(-1);
}
}
...
if (i >= argc) {
fprintf(stderr,
"no argument for # of random trials!\n");
exit(-1);
}
rand_trials = atoi(argv[i]);
if (rand_trials < 1) {
fprintf(stderr,
"Invalid # of random trials!\n");
exit(-1);
}
}
