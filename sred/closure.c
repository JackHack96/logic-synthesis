...
closure(firstprime, lastprime) int firstprime, lastprime;

{
  ...
  */
  ...
  for (i = firstprime; i < lastprime; i++)
    firstchain.weight[i] = 0;

  /* peso is the cumulative weight of all the chains */
  peso = -1;
  for (i = 0; i < firstprime; i++)
    peso += firstchain.weight[i];
  ...
  for (i = firstprime; i < lastprime; i++) {
    ...
    */
    ...
    closed =
        0; /* closed is the number of the classes of the i-th chain
    ...
    while (closed < firstchain.weight[i]) {
      closed++; /* closed is the relative address in the i-th chain of the class
                                               whose implications are currently
                   computed */
